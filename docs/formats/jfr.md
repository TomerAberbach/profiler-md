...
[Flight Recorder](https://docs.oracle.com/en/java/javase/21/jfapi/) and by
...
CPU/wall sampling measured by sample count, allocation sampling measured by
allocated bytes, and lock contention measured by blocked time.
