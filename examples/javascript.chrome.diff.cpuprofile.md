...
| stdlib            | +44.6% | +20.2ms | 10.6% → 15.5% |   45.3ms → 65.5ms |   37 → 52 |
| regexp            |  -8.4% |  -4.0ms | 11.2% → 10.4% |   47.8ms → 43.7ms |   38 → 35 |
...
|  +0.0% |  +0.1ms | 46.7% → 47.4% |         199.8ms | 159 → 160 | `(anonymous)`         | chrome-workload.mjs:1:2  |
