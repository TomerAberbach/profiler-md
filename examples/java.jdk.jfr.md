...
|  0.0% |       3 | `merge(Map, Map)`                   | org.renaissance.jdk.concurrent.JavaKMeans                                           |
|  0.0% |       2 | `lambda$run$0(int, List, int)`      | org.renaissance.jdk.concurrent.JavaKMeans                                           |
|  0.0% |       2 | `createSubtask(int, int)`           | org.renaissance.jdk.concurrent.JavaKMeans$AssignmentTask                            |
|  0.0% |       1 | `boxed(double[])`                   | org.renaissance.jdk.concurrent.JavaKMeans$UpdateTask                                |
|  0.0% |       1 | `<init>(Map)`                       | java.util.HashMap                                                                   |
|  0.0% |       1 | `div(double[], int)`                | org.renaissance.jdk.concurrent.JavaKMeans$UpdateTask                                |
...
| 15.4% |   1,002 | `computeDirectly()`                 | org.renaissance.jdk.concurrent.JavaKMeans$UpdateTask                 |
...
|      % | Samples | Callee              | Location                                             |
| -----: | ------: | ------------------- | ---------------------------------------------------- |
| 100.0% |   1,002 | `computeDirectly()` | org.renaissance.jdk.concurrent.JavaKMeans$UpdateTask |
...
| 0.0% | 7.16 MB |       8 | `lambda$generateData$4(int)`         | org.renaissance.jdk.concurrent.JavaKMeans                |
| 0.0% | 6.26 MB |       5 | `computeClusterAverages()`           | org.renaissance.jdk.concurrent.JavaKMeans$UpdateTask     |
| 0.0% | 5.29 MB |       7 | `range(int, int)`                    | java.util.stream.IntStream                               |
| 0.0% |  446 kB |       1 | `<clinit>()`                         | scala.collection.immutable.Vector$                       |
...
|      % |   Size | Samples | Callee              | Location                                             |
| -----: | -----: | ------: | ------------------- | ---------------------------------------------------- |
| 100.0% | 642 MB |      49 | `computeDirectly()` | org.renaissance.jdk.concurrent.JavaKMeans$UpdateTask |
...
|  0.0% | 14.0ms |       1 | `compute()` (org.renaissance.jdk.concurrent.JavaKMeans$RangedTask) ← `compute()` ← `compute()`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|  0.0% | 13.9ms |       1 | `compute()` (org.renaissance.jdk.concurrent.JavaKMeans$RangedTask) ← `compute()`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|  0.0% | 13.6ms |       1 | `compute()` (org.renaissance.jdk.concurrent.JavaKMeans$RangedTask) ← `compute()` ← `compute()` ← `compute()` ← `compute()` ← `compute()` ← `compute()` ← `compute()` ← `compute()`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
|  0.0% | 11.9ms |       1 | `compute()` (org.renaissance.jdk.concurrent.JavaKMeans$RangedTask) ← `average(List)` (org.renaissance.jdk.concurrent.JavaKMeans$UpdateTask) ← `computeClusterAverages()` ← `computeDirectly()` ← `computeDirectly()` ← `compute()` (org.renaissance.jdk.concurrent.JavaKMeans$RangedTask) ← `compute()`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
|  0.0% | 11.9ms |       1 | `compute()` (org.renaissance.jdk.concurrent.JavaKMeans$RangedTask) ← `average(List)` (org.renaissance.jdk.concurrent.JavaKMeans$UpdateTask) ← `computeClusterAverages()` ← `computeDirectly()` ← `computeDirectly()` ← `compute()` (org.renaissance.jdk.concurrent.JavaKMeans$RangedTask) ← `compute()` ← `compute()` ← `lambda$run$0(int, List, int)` (org.renaissance.jdk.concurrent.JavaKMeans) ← `call()` (org.renaissance.jdk.concurrent.JavaKMeans$$Lambda.0x00000088011fade8)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
