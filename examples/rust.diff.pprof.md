...
| +14.3% |  +1.0ms |  2.7% → 4.5% |   7.0ms → 8.0ms |   3 → 4 | `core::ptr::mut_ptr::<impl *mut T>::drop_in_place`                | ../../../../mike/.rustup/toolchains/stable-aarch64-apple-darwin/lib/rustlib/src/rust/library/core/src/ptr/mut_ptr.rs |
...
| +16.7% |  +1.0ms |  2.3% → 4.0% |   6.0ms → 7.0ms |   2 → 3 | `core::ptr::drop_in_place<compiler::phases::frontend::Program>`   | ../../../../mike/.rustup/toolchains/stable-aarch64-apple-darwin/lib/rustlib/src/rust/library/core/src/ptr/mod.rs     |
|    new |  +1.0ms |  0.0% → 0.6% |     0ms → 1.0ms |   0 → 1 | `core::fmt::Write::write_fmt`                                     | ../../../../mike/.rustup/toolchains/stable-aarch64-apple-darwin/lib/rustlib/src/rust/library/core/src/fmt/mod.rs     |
...
| removed | -25.0ms |   9.7% → 0.0% |      25.0ms → 0ms |   8 → 0 | `<alloc::vec::Vec<T,A> as core::clone::Clone>::clone`                                 | ../../../../mike/.rustup/toolchains/stable-aarch64-apple-darwin/lib/rustlib/src/rust/library/alloc/src/vec/mod.rs             |
...
| removed | -23.0ms |   8.9% → 0.0% |      23.0ms → 0ms |  11 → 0 | `core::option::Option<T>::map`                                                        | ../../../../mike/.rustup/toolchains/stable-aarch64-apple-darwin/lib/rustlib/src/rust/library/core/src/option.rs               |
...
|  -75.0% | -15.0ms |   7.8% → 2.8% |    20.0ms → 5.0ms |   8 → 3 | `core::ptr::drop_in_place<compiler::phases::backend::ir::Statement>`                  | `<unknown>`                                                                                                                   |
|  -65.0% | -13.0ms |   7.8% → 4.0% |    20.0ms → 7.0ms |   8 → 5 | `core::ptr::drop_in_place<alloc::vec::Vec<compiler::phases::backend::ir::Statement>>` | ../../../../mike/.rustup/toolchains/stable-aarch64-apple-darwin/lib/rustlib/src/rust/library/core/src/ptr/mod.rs              |
...
| removed |  -8.0ms |   3.1% → 0.0% |       8.0ms → 0ms |   5 → 0 | `<alloc::boxed::Box<T,A> as core::clone::Clone>::clone`                               | ../../../../mike/.rustup/toolchains/stable-aarch64-apple-darwin/lib/rustlib/src/rust/library/alloc/src/boxed.rs               |
