...
| -----: | -----: | ---: | ----------: | --------: | ------------------------------ | ----------- |
|    new | +200 B | 0.0% | 0 B → 200 B |     0 → 1 | `IntersectionObserver`         | `<unknown>` |
|    new | +136 B | 0.0% | 0 B → 136 B |     0 → 1 | `TaskAttributionTiming`        | `<unknown>` |
|    new | +120 B | 0.0% | 0 B → 120 B |     0 → 1 | `PerformanceLongTaskTiming`    | `<unknown>` |
|    new |  +40 B | 0.0% |  0 B → 40 B |     0 → 1 | `IntersectionObserverDelegate` | `<unknown>` |
...
|    new | +256 B |        0.0% |       0 B → 256 B |       0 → 1 | `PerformanceLongTaskTiming`    | `<unknown>` |
|  +4.5% | +240 B |        0.6% | 5.32 kB → 5.56 kB |           3 | `HTMLDocument`                 | `<unknown>` |
|    new | +240 B |        0.0% |       0 B → 240 B |       0 → 1 | `IntersectionObserver`         | `<unknown>` |
|    new | +136 B |        0.0% |       0 B → 136 B |       0 → 1 | `TaskAttributionTiming`        | `<unknown>` |
|    new |  +40 B |        0.0% |        0 B → 40 B |       0 → 1 | `IntersectionObserverDelegate` | `<unknown>` |
