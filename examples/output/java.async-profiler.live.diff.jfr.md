...
|     new | +1,023.998 KiB | 0.0% → <0.1% |      0 B → 1024 KiB |           0 → 2 | `div(double[], int)`                          | `org.renaissance.jdk.concurrent.JavaKMeans$UpdateTask`     |
|     new | +1,023.998 KiB | 0.0% → <0.1% |      0 B → 1024 KiB |           0 → 2 | `mapToObj(DoubleFunction, int)`               | `java.util.stream.DoublePipeline`                          |
...
| +100.0% |   +511.999 KiB |        <0.1% |  512 KiB → 1024 KiB |           1 → 2 | `<init>(InputStream)`                         | `java.util.Properties$LineReader`                          |
...
| removed | -1,023.998 KiB | <0.1% → 0.0% |      1024 KiB → 0 B |     2 → 0 | `<init>(JavaKMeans, Map)`                    | `org.renaissance.jdk.concurrent.JavaKMeans$UpdateTask`     |
| removed | -1,023.998 KiB | <0.1% → 0.0% |      1024 KiB → 0 B |     2 → 0 | `readNBytes(int)`                            | `java.io.InputStream`                                      |
...
|  -50.0% |   -511.999 KiB |        <0.1% |  1024 KiB → 512 KiB |     2 → 1 | `copyOfRangeByte(byte[], int, int)`                                             | `java.util.Arrays`                   |
...
|  -50.0% |   -511.999 KiB |        <0.1% |  1024 KiB → 512 KiB |     2 → 1 | `newLinkedHashMap(int)`                                                         | `java.util.LinkedHashMap`            |
...
|   -0.7% |   -511.999 KiB |         0.2% |  76 MiB → 75.5 MiB | 152 → 151 | `add(double[], double[])`            | `org.renaissance.jdk.concurrent.JavaKMeans$VectorSumTask`  |
|   -0.5% |   -511.999 KiB |         0.3% |            104 MiB | 209 → 208 | `lambda$collectClusters$0(Double[])` | `org.renaissance.jdk.concurrent.JavaKMeans$AssignmentTask` |
|  -50.0% |   -511.999 KiB |        <0.1% | 1024 KiB → 512 KiB |     2 → 1 | `collectGarbage(String)`             | `org.renaissance.harness.ExecutionPlugins$ForceGcPlugin`   |
...
| +350.0% |  +3.499 MiB |         <0.1% |  1024 KiB → 4.5 MiB |           2 → 9 | `parse(String[])`                                           | `org.renaissance.harness.ConfigParser`                                 |
...
| removed |   -9.999 MiB |  <0.1% → 0.0% |        10 MiB → 0 B |          20 → 0 | `linkToTargetMethod(int, int, Object, Object)`            | `java.lang.invoke.LambdaForm$MH.0x000000e801126c00`      |
|   -3.0% |   -7.999 MiB |          0.7% |   269 MiB → 261 MiB |       538 → 522 | `newNode(int, Object, Object, HashMap$Node)`              | `java.util.HashMap`                                      |
|  -83.2% |   -4.961 MiB |         <0.1% | 5.96 MiB → 1024 KiB |           6 → 2 | `accept(Object, Object)`                                  | `java.util.stream.Collectors$$Lambda.0x0000008801062690` |
|  -22.9% |   -3.999 MiB |         <0.1% | 17.5 MiB → 13.5 MiB |         29 → 21 | `copyOf(Object[], int, Class)`                            | `java.util.Arrays`                                       |
|   -6.3% |   -3.999 MiB |          0.2% |     63 MiB → 59 MiB |       126 → 118 | `valueOf(double)`                                         | `java.lang.Double`                                       |
|  -11.4% |   -3.999 MiB |          0.1% |     35 MiB → 31 MiB |         70 → 62 | `mapToObj(IntFunction, int)`                              | `java.util.stream.IntPipeline`                           |
...
|  -66.7% |     -1.999 MiB |         <0.1% |    3 MiB → 1024 KiB |           6 → 2 | `run(int, List, int)`                            | `org.renaissance.jdk.concurrent.JavaKMeans`                            |
|  -66.7% |     -1.999 MiB |         <0.1% |    3 MiB → 1024 KiB |           6 → 2 | `$anonfun$1(int)`                                | `org.renaissance.jdk.concurrent.FjKmeans`                              |
|  -66.7% |     -1.999 MiB |         <0.1% |    3 MiB → 1024 KiB |           6 → 2 | `$anonfun$adapted$1(Object)`                     | `org.renaissance.jdk.concurrent.FjKmeans`                              |
|  -66.7% |     -1.999 MiB |         <0.1% |    3 MiB → 1024 KiB |           6 → 2 | `apply(Object)`                                  | `org.renaissance.jdk.concurrent.FjKmeans$$Lambda.0x000000880117ae68`   |
...
| removed | -1,023.998 KiB |  <0.1% → 0.0% |      1024 KiB → 0 B |           2 → 0 | `<init>(JavaKMeans, Map)`                        | `org.renaissance.jdk.concurrent.JavaKMeans$UpdateTask`                 |
|  -50.0% | -1,023.998 KiB |         <0.1% |    2 MiB → 1024 KiB |           4 → 2 | `createHandler()`                                | `org.renaissance.core.Logging`                                         |
