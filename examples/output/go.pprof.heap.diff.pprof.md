...
Allocated 1.67 GiB (-2.123 MiB, -0.1%) and retained 2.09 MiB → 1.59 MiB (-516.607 KiB, -24.1%) over 21,825,387 samples → 21,882,356 samples (82.4 B → 82.1 B and 0.10052522780008437 B → 0.07608851624569128 B per sample).
