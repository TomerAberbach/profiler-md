...
| +150.0% |  +1.499 MiB |   0.1% → 0.4% | 1024 KiB → 2.5 MiB |     2 → 5 | `defineClass1(ClassLoader, String, byte[], int, int, ProtectionDomain, String)`                                          | `java.lang.ClassLoader`                                                   |
...
|     new | +1,023.998 KiB |   0.0% → 0.1% |      0 B → 1024 KiB |     0 → 2 | `addConstantMemberReference(int, String, String, String)`                                                                | `jdk.internal.org.objectweb.asm.SymbolTable`                                          |
...
|     new | +1,023.998 KiB |   0.0% → 0.1% |      0 B → 1024 KiB |     0 → 2 | `addConstantUtf8Reference(int, String)`                                                                                  | `jdk.internal.org.objectweb.asm.SymbolTable`                                          |
...
| +100.0% | +1,023.998 KiB | 0.1% → 0.3% |  1024 KiB → 2 MiB |   2 → 4 | `<init>(InputStream)`                                                                                                       | `org.jetbrains.kotlin.protobuf.CodedInputStream`                          |
|     new | +1,023.998 KiB | 0.0% → 0.1% |    0 B → 1024 KiB |   0 → 2 | `visitMethod(int, String, String, String, String[])`                                                                        | `org.jetbrains.kotlin.load.kotlin.FileBasedKotlinClass$4`                 |
...
|     new | +1,023.998 KiB | 0.0% → 0.1% |    0 B → 1024 KiB |   0 → 2 | `<init>()`                                                                                                                  | `org.jetbrains.kotlin.load.java.structure.impl.classFiles.JavaPlainType`  |
|     new | +1,023.998 KiB | 0.0% → 0.1% |    0 B → 1024 KiB |   0 → 2 | `freeze()`                                                                                                                  | `org.jetbrains.kotlin.fir.resolve.dfa.MutableFlow`                        |
|     new | +1,023.998 KiB | 0.0% → 0.1% |    0 B → 1024 KiB |   0 → 2 | `prepareForEmitting(MethodNode)`                                                                                            | `org.jetbrains.kotlin.codegen.optimization.common.UtilKt`                 |
...
|  -60.0% | -1.499 MiB | 0.4% → 0.1% | 2.5 MiB → 1024 KiB |   5 → 2 | `<init>(ClassWriter)`                                       | `jdk.internal.org.objectweb.asm.SymbolTable`                                                       |
...
|  -60.0% | -1.499 MiB | 0.4% → 0.1% | 2.5 MiB → 1024 KiB |   5 → 2 | `<init>()`                                                  | `org.jetbrains.kotlin.resolve.calls.inference.model.MutableConstraintStorage`                      |
...
|  -60.0% |     -1.499 MiB | 0.4% → 0.1% | 2.5 MiB → 1024 KiB |   5 → 2 | `<init>(ClassWriter)`                        | `jdk.internal.org.objectweb.asm.SymbolTable`                                        |
| removed |     -1.499 MiB | 0.2% → 0.0% |      1.5 MiB → 0 B |   3 → 0 | `sequencedKeySet()`                          | `java.util.LinkedHashMap`                                                           |
| removed | -1,023.998 KiB | 0.1% → 0.0% |     1024 KiB → 0 B |   2 → 0 | `newOutput()`                                | `kotlin.reflect.jvm.internal.impl.protobuf.ByteString`                              |
...
| removed | -1,023.998 KiB | 0.1% → 0.0% |     1024 KiB → 0 B |   2 → 0 | `getFileName()`                              | `jdk.internal.jrtfs.JrtPath`                                                        |
...
|  -60.0% |     -1.499 MiB | 0.4% → 0.1% | 2.5 MiB → 1024 KiB |   5 → 2 | `visitVarInsn(int, int)`                                    | `org.jetbrains.org.objectweb.asm.tree.MethodNode`                                                  |
|  -50.0% | -1,023.998 KiB | 0.3% → 0.1% |   2 MiB → 1024 KiB |   4 → 2 | `toString()`                                                | `org.jetbrains.kotlin.cli.jvm.compiler.jarfs.ByteArrayCharSequence`                                |
| removed | -1,023.998 KiB | 0.1% → 0.0% |     1024 KiB → 0 B |   2 → 0 | `subSequence(int, int)`                                     | `org.jetbrains.kotlin.cli.jvm.compiler.jarfs.ByteArrayCharSequence`                                |
| removed | -1,023.998 KiB | 0.1% → 0.0% |     1024 KiB → 0 B |   2 → 0 | `<init>(CodedInputStream, ExtensionRegistryLite)`           | `org.jetbrains.kotlin.metadata.ProtoBuf$Type`                                                      |
...
| +300.0% |   +2.999 MiB |   0.1% → 0.6% |  1024 KiB → 4 MiB |     2 → 8 | `addConstantMemberReference(int, String, String, String)`                       | `jdk.internal.org.objectweb.asm.SymbolTable`         |
...
|  -71.4% |   -2.499 MiB |  0.5% → 0.1% |  3.5 MiB → 1024 KiB |   7 → 2 | `next()`                                                               | `kotlin.sequences.TransformingSequence$iterator$1`                       |
|  -71.4% |   -2.499 MiB |  0.5% → 0.1% |  3.5 MiB → 1024 KiB |   7 → 2 | `calcNext()`                                                           | `kotlin.sequences.FilteringSequence$iterator$1`                          |
|  -71.4% |   -2.499 MiB |  0.5% → 0.1% |  3.5 MiB → 1024 KiB |   7 → 2 | `hasNext()`                                                            | `kotlin.sequences.FilteringSequence$iterator$1`                          |
...
|  -60.0% |   -1.499 MiB |  0.4% → 0.1% |  2.5 MiB → 1024 KiB |   5 → 2 | `make(MemberName)`                                                     | `java.lang.invoke.DirectMethodHandle`                                    |
|  -60.0% |   -1.499 MiB |  0.4% → 0.1% |  2.5 MiB → 1024 KiB |   5 → 2 | `findConstructor(Class, MethodType)`                                   | `java.lang.invoke.MethodHandles$Lookup`                                  |
