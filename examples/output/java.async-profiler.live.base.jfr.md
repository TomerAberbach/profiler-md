...
| <0.1% |    1 MiB |       2 | `spliterator(double[], int, int, int)`       | `java.util.Spliterators`              |
| <0.1% |    1 MiB |       2 | `copyOfRangeByte(byte[], int, int)`          | `java.util.Arrays`                    |
| <0.1% |    1 MiB |       2 | `readNBytes(int)`                            | `java.io.InputStream`                 |
...
| <0.1% |    1 MiB |       2 | `lambda$run$0(int, List, int)`       | `org.renaissance.jdk.concurrent.JavaKMeans`                |
...
|      % |  Size | Samples | Location                     |
| -----: | ----: | ------: | ---------------------------- |
| 100.0% | 1 MiB |       2 | `java.util.Spliterators:372` |

##### `copyOfRangeByte(byte[], int, int)` (`java.util.Arrays`)

|      % |  Size | Samples | Location                |
| -----: | ----: | ------: | ----------------------- |
| 100.0% | 1 MiB |       2 | `java.util.Arrays:3863` |
...
|      % |  Size | Samples | Location                                       |
| -----: | ----: | ------: | ---------------------------------------------- |
| 100.0% | 1 MiB |       2 | `org.renaissance.jdk.concurrent.JavaKMeans:53` |
...
|      % |  Size | Samples | Caller                            | Location           |
| -----: | ----: | ------: | --------------------------------- | ------------------ |
| 100.0% | 1 MiB |       2 | `spliterator(double[], int, int)` | `java.util.Arrays` |

##### `copyOfRangeByte(byte[], int, int)` (`java.util.Arrays`)

|      % |  Size | Samples | Caller                          | Location           |
| -----: | ----: | ------: | ------------------------------- | ------------------ |
| 100.0% | 1 MiB |       2 | `copyOfRange(byte[], int, int)` | `java.util.Arrays` |

##### `readNBytes(int)` (`java.io.InputStream`)

|      % |  Size | Samples | Caller           | Location              |
| -----: | ----: | ------: | ---------------- | --------------------- |
| 100.0% | 1 MiB |       2 | `readAllBytes()` | `java.io.InputStream` |

##### `lambda$run$0(int, List, int)` (`org.renaissance.jdk.concurrent.JavaKMeans`)

|      % |  Size | Samples | Caller   | Location                                                               |
| -----: | ----: | ------: | -------- | ---------------------------------------------------------------------- |
| 100.0% | 1 MiB |       2 | `call()` | `org.renaissance.jdk.concurrent.JavaKMeans$$Lambda.0x000000e801183d68` |
...
|      % |  Size | Samples | Caller       | Location                                                                          |
| -----: | ----: | ------: | ------------ | --------------------------------------------------------------------------------- |
| 100.0% | 1 MiB |       2 | `apply(int)` | `org.renaissance.jdk.concurrent.JavaKMeans$UpdateTask$$Lambda.0x000000e801187510` |
...
|  0.5% |   1 MiB |       2 | `loadClass(String)`                                                           | `java.lang.ClassLoader`                     |
|  0.5% |   1 MiB |       2 | `<init>(Map)`                                                                 | `org.renaissance.harness.ConfigParser`      |
...
|  0.5% |   1 MiB |       2 | `put(Object, Object)` | `java.util.HashMap`                                    |
