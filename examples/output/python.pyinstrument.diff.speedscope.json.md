...
Took 5.19s → 7.74s (+2.550s, +49.1%).

| Category    | Change |    Delta |             % |              Time |
| ----------- | -----: | -------: | ------------: | ----------------: |
| Ours        | +49.8% |  +2.461s | 95.2% → 95.6% |     4.94s → 7.40s |
| Native      | +35.4% | +88.11ms |   4.8% → 4.4% | 249.2ms → 337.3ms |
| Third-party |  +6.5% |  +0.06ms |         <0.1% |             1.0ms |
...
|  Change |     Delta |            % |          Time | Function                                           | Location                                    |
| ------: | --------: | -----------: | ------------: | -------------------------------------------------- | ------------------------------------------- |
| removed | -110.24ms |  2.1% → 0.0% | 110.2ms → 0ms | `object.__new__`                                   | `<built-in>`                                |
| removed |  -79.88ms |  1.5% → 0.0% |  79.9ms → 0ms | `_stringify_ast`                                   | `src/black/src/black/parsing.py:174`        |
| removed |  -68.41ms |  1.3% → 0.0% |  68.4ms → 0ms | `visit_default`                                    | `src/black/src/black/linegen.py:134`        |
| removed |  -58.62ms |  1.1% → 0.0% |  58.6ms → 0ms | `<module>`                                         | `src/black/src/black/nodes.py:1`            |
| removed |  -55.93ms |  1.1% → 0.0% |  55.9ms → 0ms | `contains_implicit_multiline_string_with_comments` | `src/black/src/black/lines.py:261`          |
| removed |  -54.99ms |  1.1% → 0.0% |  55.0ms → 0ms | `_stringify_ast_with_new_parent`                   | `src/black/src/black/parsing.py:166`        |
| removed |  -52.00ms |  1.0% → 0.0% |  52.0ms → 0ms | `convert_one_fmt_off_pair`                         | `src/black/src/black/comments.py:177`       |
| removed |   -3.02ms |  0.1% → 0.0% |   3.0ms → 0ms | `shift`                                            | `src/black/src/blib2to3/pgen2/parse.py:373` |
| removed |   -2.91ms |  0.1% → 0.0% |   2.9ms → 0ms | `<module>`                                         | `src/black/src/black/comments.py:1`         |
| removed |   -1.96ms | <0.1% → 0.0% |   2.0ms → 0ms | `format_file_in_place`                             | `src/black/src/black/__init__.py:917`       |
| removed |   -0.98ms | <0.1% → 0.0% |   1.0ms → 0ms | `convert`                                          | `src/black/src/blib2to3/pytree.py:486`      |
| removed |   -0.77ms | <0.1% → 0.0% |   0.8ms → 0ms | `__new__`                                          | `src/black/src/blib2to3/pytree.py:81`       |
|  -11.6% |   -0.40ms | 0.1% → <0.1% | 3.4ms → 3.0ms | `assert_stable`                                    | `src/black/src/black/__init__.py:1557`      |
| removed |   -0.09ms | <0.1% → 0.0% |   0.1ms → 0ms | `transform_line`                                   | `src/black/src/black/linegen.py:601`        |
|   -0.2% |   -1.83µs |        <0.1% |         1.0ms | `main`                                             | `src/black/src/black/__init__.py:244`       |
...
|  Change |     Delta |           % |          Time | Function                                           | Location                                    |
| ------: | --------: | ----------: | ------------: | -------------------------------------------------- | ------------------------------------------- |
| removed | -134.87ms | 2.6% → 0.0% | 134.9ms → 0ms | `_stringify_ast`                                   | `src/black/src/black/parsing.py:174`        |
| removed | -115.01ms | 2.2% → 0.0% | 115.0ms → 0ms | `shift`                                            | `src/black/src/blib2to3/pgen2/parse.py:373` |
| removed | -111.99ms | 2.2% → 0.0% | 112.0ms → 0ms | `convert`                                          | `src/black/src/blib2to3/pytree.py:486`      |
| removed | -111.01ms | 2.1% → 0.0% | 111.0ms → 0ms | `__new__`                                          | `src/black/src/blib2to3/pytree.py:81`       |
| removed | -110.24ms | 2.1% → 0.0% | 110.2ms → 0ms | `object.__new__`                                   | `<built-in>`                                |
| removed |  -61.53ms | 1.2% → 0.0% |  61.5ms → 0ms | `<module>`                                         | `src/black/src/black/comments.py:1`         |
| removed |  -58.62ms | 1.1% → 0.0% |  58.6ms → 0ms | `<module>`                                         | `src/black/src/black/nodes.py:1`            |
| removed |  -56.02ms | 1.1% → 0.0% |  56.0ms → 0ms | `transform_line`                                   | `src/black/src/black/linegen.py:601`        |
| removed |  -55.93ms | 1.1% → 0.0% |  55.9ms → 0ms | `contains_implicit_multiline_string_with_comments` | `src/black/src/black/lines.py:261`          |
| removed |  -54.99ms | 1.1% → 0.0% |  55.0ms → 0ms | `_stringify_ast_with_new_parent`                   | `src/black/src/black/parsing.py:166`        |
| removed |  -52.00ms | 1.0% → 0.0% |  52.0ms → 0ms | `convert_one_fmt_off_pair`                         | `src/black/src/black/comments.py:177`       |
| removed |  -52.00ms | 1.0% → 0.0% |  52.0ms → 0ms | `normalize_fmt_off`                                | `src/black/src/black/comments.py:168`       |
