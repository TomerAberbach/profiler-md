...
| removed |   -4.054 KiB |   0.2% → 0.0% |      4.05 KiB → 0 B |   37 → 0 | `encoding/json.Unmarshal` | `/nix/store/7ycp8j45iay38g9mjaxmy4jhwdsrb47y-go-1.26.3/share/go/src/encoding/json/decode.go:102` |
