...
| +900.0% | +900.00ms | 0.2% → 2.4% | 100.0ms → 999.9ms |  1 → 10 | `CPyDef_brackets___is_split_before_delimiter`                          | `/venv/lib/python3.11/site-packages/30fcd23745efe32ce681__mypyc.cpython-311-x86_64-linux-gnu.so` |
...
|  Change |     Delta |           % |              Time | Samples | Function                                                                | Location                                                                                         |
| ------: | --------: | ----------: | ----------------: | ------: | ----------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
|  -90.0% | -900.00ms | 2.3% → 0.2% | 999.9ms → 100.0ms |  10 → 1 | `CPyDef_parse___Parser___shift`                                         | `/venv/lib/python3.11/site-packages/30fcd23745efe32ce681__mypyc.cpython-311-x86_64-linux-gnu.so` |
...
|  +70.0% | +700.00ms |   2.3% → 4.0% |   999.9ms → 1.70s |   10 → 17 | `CPyDef_comments___generate_comments_gen_____mypyc_generator_helper__`              | `/venv/lib/python3.11/site-packages/30fcd23745efe32ce681__mypyc.cpython-311-x86_64-linux-gnu.so` |
...
|  +70.0% | +700.00ms |   2.3% → 4.0% |   999.9ms → 1.70s |   10 → 17 | `CPyDef_comments___generate_comments_gen_____mypyc_generator_helper__`              | `/venv/lib/python3.11/site-packages/30fcd23745efe32ce681__mypyc.cpython-311-x86_64-linux-gnu.so` |
| +350.0% | +700.00ms |   0.5% → 2.1% | 200.0ms → 900.0ms |     2 → 9 | `CPyDef_linegen___right_hand_split_gen_____mypyc_generator_helper__`                | `/venv/lib/python3.11/site-packages/30fcd23745efe32ce681__mypyc.cpython-311-x86_64-linux-gnu.so` |
| +233.3% | +700.00ms |   0.7% → 2.4% | 300.0ms → 999.9ms |    3 → 10 | `CPyDef_brackets___is_split_before_delimiter`                                       | `/venv/lib/python3.11/site-packages/30fcd23745efe32ce681__mypyc.cpython-311-x86_64-linux-gnu.so` |
...
|  -28.6% | -400.00ms |   3.3% → 2.4% |   1.40s → 999.9ms |   14 → 10 | `parse`                     | `/usr/lib/python3.11/ast.py`              |
| removed | -300.00ms |   0.7% → 0.0% |     300.0ms → 0ms |     3 → 0 | `<module>`                  | `/usr/lib/python3.11/dis.py`              |
