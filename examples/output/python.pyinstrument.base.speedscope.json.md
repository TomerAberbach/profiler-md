...
|  97.4% |   5.06s | `main`                            | `venv/lib/python3.11/site-packages/click/core.py:1422`     |
...
|  97.4% |   5.05s | `new_func`                        | `venv/lib/python3.11/site-packages/click/decorators.py:33` |
|  97.4% |   5.05s | `invoke`                          | `venv/lib/python3.11/site-packages/click/core.py:853`      |
|  97.4% |   5.05s | `invoke`                          | `venv/lib/python3.11/site-packages/click/core.py:1339`     |
...
|      % |  Time | Callee   | Location                                               |
| -----: | ----: | -------- | ------------------------------------------------------ |
| 100.0% | 5.05s | `invoke` | `venv/lib/python3.11/site-packages/click/core.py:1339` |

##### `__call__` (`venv/lib/python3.11/site-packages/click/core.py:1567`)

|      % |  Time | Callee | Location                                               |
| -----: | ----: | ------ | ------------------------------------------------------ |
| 100.0% | 5.06s | `main` | `venv/lib/python3.11/site-packages/click/core.py:1422` |
...
|      % |  Time | Callee | Location                              |
| -----: | ----: | ------ | ------------------------------------- |
| 100.0% | 5.05s | `main` | `src/black/src/black/__init__.py:244` |

##### `invoke` (`venv/lib/python3.11/site-packages/click/core.py:853`)

|      % |  Time | Callee     | Location                                                   |
| -----: | ----: | ---------- | ---------------------------------------------------------- |
| 100.0% | 5.05s | `new_func` | `venv/lib/python3.11/site-packages/click/decorators.py:33` |

##### `invoke` (`venv/lib/python3.11/site-packages/click/core.py:1339`)

|      % |  Time | Callee   | Location                                              |
| -----: | ----: | -------- | ----------------------------------------------------- |
| 100.0% | 5.05s | `invoke` | `venv/lib/python3.11/site-packages/click/core.py:853` |
...
|  5.3% | 275.9ms | `assert_equivalent` (`src/black/src/black/__init__.py:1524`) ← `check_stability_and_equivalence` (1037) ← `format_file_contents` (1054) ← `format_file_in_place` (917) ← `reformat_one` (860) ← `main` (244) ← `new_func` (`venv/lib/python3.11/site-packages/click/decorators.py:33`) ← `invoke` (`venv/lib/python3.11/site-packages/click/core.py:853`) ← `invoke` (1339) ← `main` (1422) ← `__call__` (1567) ← `patched_main` (`src/black/src/black/__init__.py:1594`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
|  0.1% |   4.1ms | `check_stability_and_equivalence` (`src/black/src/black/__init__.py:1037`) ← `format_file_contents` (1054) ← `format_file_in_place` (917) ← `reformat_one` (860) ← `main` (244) ← `new_func` (`venv/lib/python3.11/site-packages/click/decorators.py:33`) ← `invoke` (`venv/lib/python3.11/site-packages/click/core.py:853`) ← `invoke` (1339) ← `main` (1422) ← `__call__` (1567) ← `patched_main` (`src/black/src/black/__init__.py:1594`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
|  0.1% |   3.4ms | `assert_stable` (`src/black/src/black/__init__.py:1557`) ← `check_stability_and_equivalence` (1037) ← `format_file_contents` (1054) ← `format_file_in_place` (917) ← `reformat_one` (860) ← `main` (244) ← `new_func` (`venv/lib/python3.11/site-packages/click/decorators.py:33`) ← `invoke` (`venv/lib/python3.11/site-packages/click/core.py:853`) ← `invoke` (1339) ← `main` (1422) ← `__call__` (1567) ← `patched_main` (`src/black/src/black/__init__.py:1594`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
