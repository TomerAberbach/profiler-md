...
Allocated 1.55 MB (-3.008 kB, -0.2%) across 16,629 → 16,601 nodes and 44,433 → 44,305 edges.

| Category     | Change |     Delta |             % |              Size |         Nodes |
| ------------ | -----: | --------: | ------------: | ----------------: | ------------: |
| code         |   0.0% |       0 B | 43.9% → 44.0% |            681 kB |         3,188 |
| string       |   0.0% |       0 B | 23.5% → 23.6% |            365 kB |         6,272 |
| object shape |  -1.5% | -2.912 kB | 12.7% → 12.6% |   198 kB → 195 kB | 1,764 → 1,738 |
...
| -----: | --------: | -----------: | --------------: | --------: | --------------------- |
|  -0.2% | -3.008 kB |        83.7% |          1.3 MB |         1 | `GlobalObject`        |
|  -8.3% | -1.264 kB |  1.0% → 0.9% | 15.3 kB → 14 kB |         1 | `ReadStream`          |
