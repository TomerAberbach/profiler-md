...
| 10.3% |   2,035 | `escape_binary_ascii/5` | `json`    |
|  7.2% |   1,420 | `escape_binary_utf8/6`  | `json`    |
...
|  1.3% |     259 | `do_encode_map/2` (`json`) ← `do_encode_map/2` ← `do_encode_map/2` ← `encode/1` (`profile`)                                         |
...
|  0.5% |      92 | `escape_binary_ascii/5` (`json`) ← `do_encode_map/2` ← `do_encode_map/2` ← `do_encode_map/2` ← `encode/1` (`profile`)               |
