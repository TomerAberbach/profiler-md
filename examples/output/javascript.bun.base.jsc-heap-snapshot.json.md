...
Allocated 1.46 MiB across 16,676 nodes and 45,239 edges.

| Category           |     % |     Size | Nodes |
| ------------------ | ----: | -------: | ----: |
| Code               | 42.8% |  640 KiB | 2,765 |
| String             | 23.8% |  356 KiB | 6,250 |
| Object shape       | 13.6% |  204 KiB | 1,862 |
| Object             |  7.7% |  115 KiB | 1,494 |
| Internal           |  6.4% | 95.1 KiB | 1,299 |
| Function           |  4.4% | 65.1 KiB | 1,811 |
...
|  1.2% | 18.2 KiB |       389 | `PropertyTable`              |
...
|     % |     Size | Instances | Constructor                  |
| ----: | -------: | --------: | ---------------------------- |
| 83.7% | 1.22 MiB |         1 | `GlobalObject`               |
| 41.5% |  620 KiB |     1,373 | `Object`                     |
| 31.8% |  475 KiB |       931 | `FunctionExecutable`         |
| 29.9% |  446 KiB |     1,077 | `Array`                      |
| 19.0% |  284 KiB |     1,732 | `Function`                   |
| 17.9% |  267 KiB |       122 | `FunctionCodeBlock`          |
| 15.8% |  236 KiB |     1,862 | `Structure`                  |
|  6.1% | 90.9 KiB |       121 | `UnlinkedFunctionCodeBlock`  |
|  5.8% | 86.7 KiB |       925 | `UnlinkedFunctionExecutable` |
...
|  1.3% | 20.2 KiB |       103 | `StructureRareData`          |
|  1.3% | 18.9 KiB |         1 | `Process`                    |
|  1.2% | 18.1 KiB |       389 | `PropertyTable`              |
...
|     % |     Size | Instances | Path                                                                                                            |
| ----: | -------: | --------: | --------------------------------------------------------------------------------------------------------------- |
| 32.0% | 85.6 KiB |         6 | `FunctionExecutable ← <root>`                                                                                   |
...
| 5.7% | 13.3 KiB |         1 | `Structure ← Object ← GlobalObject ← <root>`                                     |
| 5.6% | 13.2 KiB |         1 | `Structure ← Structure ← Object ← GlobalObject ← <root>`                         |
| 5.6% | 13.1 KiB |         1 | `Structure ← Structure ← Structure ← Object ← GlobalObject ← <root>`             |
...
|     % |     Size | Instances | Path                                                                                                                              |
| ----: | -------: | --------: | --------------------------------------------------------------------------------------------------------------------------------- |
| 16.6% | 3.34 KiB |         1 | `Structure ← ReadStream ← <root>`                                                                                                 |
| 15.6% | 3.14 KiB |         1 | `Structure ← StructureRareData ← Structure ← ReadStream ← <root>`                                                                 |
| 14.6% | 2.94 KiB |         1 | `Structure ← StructureRareData ← Structure ← StructureRareData ← Structure ← ReadStream ← <root>`                                 |
| 14.0% | 2.83 KiB |         1 | `Structure ← <root>`                                                                                                              |
| 13.6% | 2.73 KiB |         1 | `Structure ← StructureRareData ← Structure ← StructureRareData ← Structure ← StructureRareData ← Structure ← ReadStream ← <root>` |

##### `Process`

|      % |     Size | Instances | Path                    |
| -----: | -------: | --------: | ----------------------- |
| 100.0% | 18.9 KiB |         1 | `GlobalObject ← <root>` |
