...
|     % |     Size | Instances | Path                                          |
| ----: | -------: | --------: | --------------------------------------------- |
| 70.2% | 18.2 KiB |        34 | `.__retained Window / http://127.0.0.1:52789` |
...
| 40.8% | 5.86 KiB |        30 | `[4] <article class="status"> ← .__retained Window / http://127.0.0.1:52789` |
|  5.4% |    800 B |         4 | `.__retained Window / http://127.0.0.1:52789`                                |
...
| ----: | -------: | --------: | ---------------------------------------------------------------------------- |
| 53.8% | 7.73 KiB |        66 | `(GC root)`                                                                  |
| 46.2% | 6.64 KiB |        34 | `[3] <article class="status"> ← .__retained Window / http://127.0.0.1:52789` |
