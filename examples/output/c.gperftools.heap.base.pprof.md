...
|     % |  Size | Objects | Call stack                                                                                                                                                 |
| ----: | ----: | ------: | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 33.3% | 304 B |       1 | `POOL_create` ← `AIO_IOPool_init` (`fileio_asyncio.c`) ← `AIO_WritePool_create` ← `FIO_createCResources` (`fileio.c`)                                      |
| 33.3% | 304 B |       1 | `POOL_create` ← `AIO_IOPool_init` (`fileio_asyncio.c`) ← `AIO_ReadPool_create` ← `FIO_createCResources` (`fileio.c`)                                       |
| 33.3% | 304 B |       1 | `ZSTDMT_createCCtx_advanced` ← `ZSTD_CCtx_init_compressStream2` (`zstd_compress.c`) ← `ZSTD_compressStream2` ← `FIO_compressFilename_srcFile` (`fileio.c`) |
