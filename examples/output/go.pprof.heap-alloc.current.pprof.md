...
Allocated 1.67 GiB and retained 1.59 MiB over 21,882,388 samples (82.1 B and 0.07608840497664149 B per sample).

| Category |      % | Allocated | Retained |    Samples |
| -------- | -----: | --------: | -------: | ---------: |
| stdlib   | 100.0% |  1.67 GiB | 1.59 MiB | 21,882,132 |
...
|  0.1% | 1.13 MiB |         87 | `main.main`                     | `profile.go:61`                                                                                  |
|  0.1% | 1.13 MiB |          2 | `runtime/pprof.StartCPUProfile` | `/nix/store/7ycp8j45iay38g9mjaxmy4jhwdsrb47y-go-1.26.3/share/go/src/runtime/pprof/pprof.go:888`  |
