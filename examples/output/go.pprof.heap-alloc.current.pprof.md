...
Allocated 1.8 GB and retained 1.66 MB over 21,882,388 samples (82.1 B and 0.07608840497664149 B per sample).

| Category |      % | Allocated | Retained |    Samples |
| -------- | -----: | --------: | -------: | ---------: |
| stdlib   | 100.0% |    1.8 GB |  1.66 MB | 21,882,132 |
...
| <0.1% |  4.1 kB |     256 | `main.workload.func1`           | `profile.go:25`                                                                                  |
...
|      % |   Size | Samples | Location        |
| -----: | -----: | ------: | --------------- |
| 100.0% | 4.1 kB |     256 | `profile.go:28` |
...
|      % |    Size | Samples | Caller                | Location        |
| -----: | ------: | ------: | --------------------- | --------------- |
| 100.0% | 79.2 kB |     550 | `main.workload.func1` | `profile.go:25` |
...
|     % |    Size |    Samples | Function                        | Location                                                                                         |
| ----: | ------: | ---------: | ------------------------------- | ------------------------------------------------------------------------------------------------ |
| 99.8% | 1.79 GB | 21,880,349 | `main.workload.func1`           | `profile.go:25`                                                                                  |
...
|  0.1% | 1.18 MB |         87 | `main.main`                     | `profile.go:61`                                                                                  |
|  0.1% | 1.18 MB |          2 | `runtime/pprof.StartCPUProfile` | `/nix/store/7ycp8j45iay38g9mjaxmy4jhwdsrb47y-go-1.26.3/share/go/src/runtime/pprof/pprof.go:888`  |
...
| ----: | ------: | ---------: | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 53.6% |  962 MB | 11,225,798 | `encoding/json.Marshal` (`/nix/store/7ycp8j45iay38g9mjaxmy4jhwdsrb47y-go-1.26.3/share/go/src/encoding/json/encode.go:205`) ← `main.workload.func1` (`profile.go:25`)   |
| 46.3% |  831 MB | 10,654,295 | `encoding/json.Unmarshal` (`/nix/store/7ycp8j45iay38g9mjaxmy4jhwdsrb47y-go-1.26.3/share/go/src/encoding/json/decode.go:102`) ← `main.workload.func1` (`profile.go:25`) |
...
|     % |    Size |    Samples | Function                | Location                                                                                         |
| ----: | ------: | ---------: | ----------------------- | ------------------------------------------------------------------------------------------------ |
| 95.2% | 1.59 MB | 21,880,349 | `main.workload.func1`   | `profile.go:25`                                                                                  |
...
|     % |    Size |    Samples | Call stack                                                                                                                                                           |
| ----: | ------: | ---------: | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 95.2% | 1.59 MB | 11,225,798 | `encoding/json.Marshal` (`/nix/store/7ycp8j45iay38g9mjaxmy4jhwdsrb47y-go-1.26.3/share/go/src/encoding/json/encode.go:205`) ← `main.workload.func1` (`profile.go:25`) |
