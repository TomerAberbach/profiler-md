...
| <0.1% | 1024 KiB |       2 | `allocateUninitializedArray(Class, int)`     | `jdk.internal.misc.Unsafe`            |
...
|      % |     Size | Samples | Location                        |
| -----: | -------: | ------: | ------------------------------- |
| 100.0% | 1024 KiB |       2 | `jdk.internal.misc.Unsafe:1380` |
...
|      % |     Size | Samples | Caller           | Location                       |
| -----: | -------: | ------: | ---------------- | ------------------------------ |
| 100.0% | 1024 KiB |       2 | `newArray(long)` | `java.lang.StringConcatHelper` |
