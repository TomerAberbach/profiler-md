...
| <0.1% |    1 MiB |       2 | `<init>(InputStream)`                         | `java.util.Properties$LineReader`     |
...
|     % |    Size | Samples | Location                                       |
| ----: | ------: | ------: | ---------------------------------------------- |
| 66.7% |   1 MiB |       2 | `org.renaissance.jdk.concurrent.JavaKMeans:53` |
...
|      % |  Size | Samples | Location                              |
| -----: | ----: | ------: | ------------------------------------- |
| 100.0% | 1 MiB |       2 | `java.util.Properties$LineReader:471` |
...
|  1.7% |  1 MiB |       2 | `combineResults(Map, Map)` | `org.renaissance.jdk.concurrent.JavaKMeans$UpdateTask`     |
...
|      % |  Size | Samples | Caller              | Location               |
| -----: | ----: | ------: | ------------------- | ---------------------- |
| 100.0% | 1 MiB |       2 | `load(InputStream)` | `java.util.Properties` |
...
|      % |  Size | Samples | Caller       | Location                                                                          |
| -----: | ----: | ------: | ------------ | --------------------------------------------------------------------------------- |
| 100.0% | 1 MiB |       2 | `apply(int)` | `org.renaissance.jdk.concurrent.JavaKMeans$UpdateTask$$Lambda.0x0000008801187510` |
