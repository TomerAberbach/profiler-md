...
|     % |    Time | Samples | Callee                               | Location                                |
| ----: | ------: | ------: | ------------------------------------ | --------------------------------------- |
| 48.2% | 678.0ms |     678 | `zig.Ast.Render.renderToken`         | `../opt/zig/lib/std/zig/Ast/Render.zig` |
| 40.5% | 570.0ms |     570 | `zig.Ast.Render.tokenSliceForRender` | `../opt/zig/lib/std/zig/Ast/Render.zig` |
|  2.9% |  41.0ms |      41 | `array_hash_map.Custom.get`          | `../opt/zig/lib/std/array_hash_map.zig` |
