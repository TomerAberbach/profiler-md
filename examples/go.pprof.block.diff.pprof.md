...
Blocked 1.41s → 1.40s (-3.9ms, -0.3%) over 14 samples → 12 samples (101.0ms → 117.5ms per sample).

| Category | Change |  Delta |      % |          Time | Samples |
| -------- | -----: | -----: | -----: | ------------: | ------: |
| stdlib   |  -0.3% | -3.9ms | 100.0% | 1.41s → 1.40s | 14 → 12 |
...
| +117.6% |  +7.8µs |         <0.1% | 6.6µs → 14.4µs |      10 | `encoding/json.Unmarshal` | nix/store/7ycp8j45iay38g9mjaxmy4jhwdsrb47y-go-1.26.3/share/go/src/encoding/json/decode.go:102 |
...
|  -61.6% | -23.1µs |        <0.1% |   37.5µs → 14.4µs | 12 → 10 | `main.workload.func1`          | Users/tomer/Documents/work/code/profiler-md/scripts/fixtures/assets/go/profile.go:25          |
