...
| ------: | -------: | ------------: | -------------: | ------: | ------------------------- | ----------------------------------------------------------------------------------------------- |
|   +2.7% | +34.59ms | 89.7% → 92.4% |  1.26s → 1.30s |       1 | `sync.(*WaitGroup).Wait`  | `nix/store/7ycp8j45iay38g9mjaxmy4jhwdsrb47y-go-1.26.3/share/go/src/sync/waitgroup.go:160`       |
|   +2.7% | +34.59ms | 89.7% → 92.4% |  1.26s → 1.30s |       1 | `main.workload`           | `Users/tomer/Documents/work/code/profiler-md/scripts/fixtures/assets/go/profile.go:16`          |
...
|   -0.3% |  -3.83ms |       100.0% |     1.41s → 1.40s |       2 | `main.main`                    | `Users/tomer/Documents/work/code/profiler-md/scripts/fixtures/assets/go/profile.go:61`          |
...
|  -61.6% |  -0.02ms |        <0.1% |   37.5µs → 14.4µs | 12 → 10 | `main.workload.func1`          | `Users/tomer/Documents/work/code/profiler-md/scripts/fixtures/assets/go/profile.go:25`          |
