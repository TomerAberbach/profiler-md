...
Allocated 40.3 GB over 1,984 samples → 2,040 samples (20.3 MB → 19.7 MB per sample).
...
Retained 2.68 MB over 9 samples → 8 samples (298 kB → 336 kB per sample).
...
Blocked 7.15s → 7.14s (-0.01s, -0.1%) over 59 samples → 54 samples (121.3ms → 132.4ms per sample).
