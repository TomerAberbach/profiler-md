...
Allocated 1.55 MB across 16,629 nodes and 44,433 edges.

| Category     |     % |    Size | Nodes |
| ------------ | ----: | ------: | ----: |
| code         | 43.9% |  681 kB | 3,188 |
| string       | 23.5% |  365 kB | 6,272 |
| object shape | 12.7% |  198 kB | 1,764 |
| object       |  9.3% |  145 kB | 1,484 |
| hidden       |  5.0% | 77.3 kB |   962 |
| closure      |  4.3% | 66.4 kB | 1,805 |
| array        |  1.1% | 17.2 kB | 1,072 |
| symbol       |  0.1% | 1.23 kB |    77 |
| native       |  0.0% |   328 B |     1 |
| regexp       |  0.0% |    64 B |     2 |
| bigint       |  0.0% |    32 B |     1 |
| synthetic    |  0.0% |     0 B |     1 |
...
| ---: | ------: | --------: | ----------------------------------- |
| 6.4% |   99 kB |     1,367 | `Object`                            |
| 1.8% | 28.2 kB |         4 | `ModuleRecord`                      |
| 0.7% | 10.5 kB |         1 | `GlobalObject`                      |
| 0.1% | 1.22 kB |         1 | `InternalModuleRegistry`            |
| 0.1% | 1.17 kB |         2 | `NodeJSFS`                          |
| 0.1% |   779 B |         3 | `FileSink`                          |
| 0.0% |   659 B |         2 | `FileInternalReadableStreamSource`  |
| 0.0% |   363 B |         2 | `Blob`                              |
| 0.0% |   329 B |        10 | `Map`                               |
| 0.0% |   256 B |         8 | `Promise (fulfilled: Object)`       |
| 0.0% |   242 B |         2 | `WriteStream`                       |
| 0.0% |   213 B |         1 | `url `                              |
| 0.0% |   128 B |         4 | `Promise (fulfilled: JSSourceCode)` |
| 0.0% |   108 B |         3 | `Set`                               |
| 0.0% |    96 B |         3 | `Callee`                            |
| 0.0% |    89 B |         2 | `ReadableStream`                    |
| 0.0% |    89 B |         1 | `ReadStream`                        |
| 0.0% |    70 B |         1 | `String`                            |
| 0.0% |    65 B |         1 | `ModuleNamespaceObject`             |
| 0.0% |    64 B |         2 | `Promise (fulfilled)`               |
...
|    % |    Size | Instances | Path                                                                              |
| ---: | ------: | --------: | --------------------------------------------------------------------------------- |
| 1.9% | 1.84 kB |         5 | `(GC root)`                                                                       |
| 1.2% | 1.23 kB |         5 | `. InternalModuleRegistry ← .internalModuleRegistry GlobalObject`                 |
...
|      % |    Size | Instances | Path        |
| -----: | ------: | --------: | ----------- |
| 100.0% | 28.2 kB |         4 | `(GC root)` |

##### `GlobalObject`

|      % |    Size | Instances | Path        |
| -----: | ------: | --------: | ----------- |
| 100.0% | 10.5 kB |         1 | `(GC root)` |

##### `InternalModuleRegistry`

|      % |    Size | Instances | Path                                   |
| -----: | ------: | --------: | -------------------------------------- |
| 100.0% | 1.22 kB |         1 | `.internalModuleRegistry GlobalObject` |

##### `NodeJSFS`

|     % |    Size | Instances | Path                           |
| ----: | ------: | --------: | ------------------------------ |
| 90.9% | 1.06 kB |         1 | `(GC root)`                    |
...
|     % |    Size | Instances | Constructor                        |
| ----: | ------: | --------: | ---------------------------------- |
| 83.7% |  1.3 MB |         1 | `GlobalObject`                     |
| 40.2% |  624 kB |     1,367 | `Object`                           |
|  3.5% | 53.6 kB |         1 | `InternalModuleRegistry`           |
|  3.4% | 53.1 kB |         1 | `url `                             |
|  1.5% | 22.9 kB |         1 | `ModuleLoader`                     |
|  1.1% | 17.2 kB |        10 | `Map`                              |
|  1.0% | 15.3 kB |         1 | `ReadStream`                       |
|  0.6% | 8.87 kB |         2 | `WriteStream`                      |
|  0.3% | 5.02 kB |         1 | `console`                          |
|  0.3% |    5 kB |         1 | `Prototype`                        |
|  0.3% | 4.99 kB |         1 | `Math`                             |
|  0.3% | 4.57 kB |         1 | `String`                           |
|  0.3% | 4.32 kB |         2 | `ReadableStream`                   |
|  0.2% | 3.05 kB |         2 | `Iterator`                         |
|  0.2% | 3.03 kB |         2 | `NodeJSFS`                         |
|  0.2% | 2.44 kB |         2 | `Blob`                             |
|  0.2% | 2.41 kB |         2 | `ArrayBuffer`                      |
|  0.1% | 2.22 kB |         1 | `EventEmitter`                     |
|  0.1% | 2.01 kB |         3 | `FileSink`                         |
|  0.1% | 1.94 kB |         2 | `FileInternalReadableStreamSource` |
...
|      % |   Size | Instances | Path        |
| -----: | -----: | --------: | ----------- |
| 100.0% | 1.3 MB |         1 | `(GC root)` |

##### `Object`

|     % |    Size | Instances | Path                                                                            |
| ----: | ------: | --------: | ------------------------------------------------------------------------------- |
| 75.2% |  469 kB |         1 | `.__retained GlobalObject`                                                      |
| 72.5% |  452 kB |         1 | `.data Object ← .__retained GlobalObject`                                       |
|  5.9% |   37 kB |         2 | `(GC root)`                                                                     |
|  5.1% | 31.9 kB |         2 | `. InternalModuleRegistry ← .internalModuleRegistry GlobalObject`               |
|  1.4% | 8.68 kB |         1 | `[12] Array (100) ← .statuses Object ← .data Object ← .__retained GlobalObject` |

##### `InternalModuleRegistry`

|      % |    Size | Instances | Path                                   |
| -----: | ------: | --------: | -------------------------------------- |
| 100.0% | 53.6 kB |         1 | `.internalModuleRegistry GlobalObject` |

##### `url `

|      % |    Size | Instances | Path                    |
| -----: | ------: | --------: | ----------------------- |
| 100.0% | 53.1 kB |         1 | `.process GlobalObject` |

##### `ModuleLoader`

|      % |    Size | Instances | Path                   |
| -----: | ------: | --------: | ---------------------- |
| 100.0% | 22.9 kB |         1 | `.Loader GlobalObject` |

##### `Map`

|     % |    Size | Instances | Path                                                                                                                                    |
| ----: | ------: | --------: | --------------------------------------------------------------------------------------------------------------------------------------- |
| 95.5% | 16.5 kB |         1 | `.byId Object ← .__retained GlobalObject`                                                                                               |
|  2.3% |   393 B |         3 | `(GC root)`                                                                                                                             |
...
|      % |    Size | Instances | Path                                  |
| -----: | ------: | --------: | ------------------------------------- |
| 100.0% | 15.3 kB |         1 | `.stdin url  ← .process GlobalObject` |

##### `WriteStream`

|     % |    Size | Instances | Path                                   |
| ----: | ------: | --------: | -------------------------------------- |
| 50.6% | 4.48 kB |         1 | `.stdout url  ← .process GlobalObject` |
| 49.4% | 4.38 kB |         1 | `.stderr url  ← .process GlobalObject` |

##### `console`

|      % |    Size | Instances | Path                    |
| -----: | ------: | --------: | ----------------------- |
| 100.0% | 5.02 kB |         1 | `.console GlobalObject` |

##### `Prototype`

|      % | Size | Instances | Path             |
| -----: | ---: | --------: | ---------------- |
| 100.0% | 5 kB |         1 | `. GlobalObject` |

##### `Math`

|      % |    Size | Instances | Path                 |
| -----: | ------: | --------: | -------------------- |
| 100.0% | 4.99 kB |         1 | `.Math GlobalObject` |

##### `String`

|      % |    Size | Instances | Path             |
| -----: | ------: | --------: | ---------------- |
| 100.0% | 4.57 kB |         1 | `. GlobalObject` |

##### `ReadableStream`

|      % |    Size | Instances | Path        |
| -----: | ------: | --------: | ----------- |
| 100.0% | 4.32 kB |         2 | `(GC root)` |

##### `Iterator`

|     % |    Size | Instances | Path                           |
| ----: | ------: | --------: | ------------------------------ |
| 79.2% | 2.42 kB |         1 | `. GlobalObject`               |
...
|     % |    Size | Instances | Path                           |
| ----: | ------: | --------: | ------------------------------ |
| 64.8% | 1.96 kB |         1 | `. Structure ← . GlobalObject` |
| 35.2% | 1.06 kB |         1 | `(GC root)`                    |

##### `Blob`

|     % |    Size | Instances | Path             |
| ----: | ------: | --------: | ---------------- |
| 86.6% | 2.12 kB |         1 | `(GC root)`      |
...
|      % |    Size | Instances | Path        |
| -----: | ------: | --------: | ----------- |
| 100.0% | 2.41 kB |         2 | `(GC root)` |

##### `EventEmitter`

|      % |    Size | Instances | Path        |
| -----: | ------: | --------: | ----------- |
| 100.0% | 2.22 kB |         1 | `(GC root)` |

##### `FileSink`

|     % |    Size | Instances | Path                                                                       |
| ----: | ------: | --------: | -------------------------------------------------------------------------- |
| 62.6% | 1.26 kB |         1 | `. Structure ← . GlobalObject`                                             |
...
| ---: | -------: | --------: | ----: | -------------------- | ----------------------------------------------------------------------------------- |
| 4.5% |  69.8 kB |       374 |   344 | `Function`           | `.createNativeReadableStream GlobalObject`                                          |
| 0.6% |   8.8 kB |         3 |     3 | `matchesGlob`        | `. InternalModuleRegistry ← .internalModuleRegistry GlobalObject`                   |
| 0.4% |  6.36 kB |         1 |     1 | `duplexPair`         | `(GC root)`                                                                         |
| 0.4% |  6.09 kB |        41 |    28 | `AsyncFunction`      | `.Symbol.asyncDispose Object`                                                       |
| 0.4% |  6.01 kB |        10 |    10 | `SafeIterator`       | `(GC root)`                                                                         |
| 0.3% |  5.24 kB |         1 |     1 | `SafeMap`            | `.SafeMap Object ← . InternalModuleRegistry ← .internalModuleRegistry GlobalObject` |
| 0.3% |  5.02 kB |         1 |     1 | `SafeSet`            | `(GC root)`                                                                         |
| 0.3% |   4.6 kB |         1 |     1 | `requestInstantiate` | `.requestInstantiate ModuleLoader ← .Loader GlobalObject`                           |
| 0.3% |     4 kB |         1 |     1 | `requestSatisfyUtil` | `.requestSatisfyUtil ModuleLoader ← .Loader GlobalObject`                           |
| 0.3% |  3.89 kB |         2 |     1 | `compose`            | `(GC root)`                                                                         |
| 0.2% |  3.81 kB |         1 |     1 | `Object`             | `(GC root)`                                                                         |
| 0.2% |  3.19 kB |         1 |     1 | `PassThrough`        | `(GC root)`                                                                         |
| 0.2% |  3.14 kB |        25 |    24 | `anonymous`          | `.charCodeAt String ← . GlobalObject`                                               |
| 0.2% |  3.12 kB |         2 |     2 | `pipeline`           | `.pipeline Object`                                                                  |
| 0.2% |  3.02 kB |        85 |    54 | `get`                | `. GetterSetter ← .self GlobalObject`                                               |
| 0.2% |  2.55 kB |         1 |     1 | `Stream`             | `(GC root)`                                                                         |
| 0.2% |  2.45 kB |         6 |     3 | `forEach`            | `(GC root)`                                                                         |
| 0.2% |  2.41 kB |        63 |    44 | `set`                | `. GetterSetter ← .self GlobalObject`                                               |
| 0.2% |  2.39 kB |        20 |    20 | `call`               | `(GC root)`                                                                         |
| 0.2% |  2.34 kB |         1 |     1 | `newRegistryEntry`   | `. GlobalObject`                                                                    |
...
|     % |    Self | Name                         | Path                                                                                                                            |
| ----: | ------: | ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| 73.9% |  6.5 kB | `FunctionCodeBlock`          | `. FunctionExecutable ← . FunctionExecutable ← . matchesGlob ← . InternalModuleRegistry ← .internalModuleRegistry GlobalObject` |
| 15.0% | 1.32 kB | `UnlinkedFunctionCodeBlock`  | `. FunctionExecutable ← . matchesGlob ← . InternalModuleRegistry ← .internalModuleRegistry GlobalObject`                        |
...
|     % |    Self | Name                        | Path                   |
| ----: | ------: | --------------------------- | ---------------------- |
| 22.7% | 1.44 kB | `FunctionCodeBlock`         | `. FunctionExecutable` |
...
|     % |    Self | Name                 | Path                                                                                                                                                                                              |
| ----: | ------: | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 57.5% | 2.64 kB | `FunctionCodeBlock`  | `. FunctionExecutable ← . FunctionCodeBlock ← . FunctionExecutable ← . FunctionCodeBlock ← . FunctionExecutable ← . requestInstantiate ← .requestInstantiate ModuleLoader ← .Loader GlobalObject` |
...
|     % |    Self | Name                 | Path                                                                                                                                                                                              |
| ----: | ------: | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 48.5% | 1.94 kB | `FunctionCodeBlock`  | `. FunctionExecutable ← . FunctionCodeBlock ← . FunctionExecutable ← . requestSatisfyUtil ← .requestSatisfyUtil ModuleLoader ← .Loader GlobalObject`                                              |
...
|     % |    Self | Name                        | Path                                                      |
| ----: | ------: | --------------------------- | --------------------------------------------------------- |
| 53.6% | 2.08 kB | `FunctionCodeBlock`         | `. FunctionExecutable ← . FunctionExecutable ← . compose` |
...
|     % |    Self | Name                        | Path                                                                          |
| ----: | ------: | --------------------------- | ----------------------------------------------------------------------------- |
| 44.0% | 1.37 kB | `FunctionCodeBlock`         | `. FunctionExecutable ← . FunctionExecutable ← . pipeline ← .pipeline Object` |
...
|    % |  Size | Value                                                    | Path                                                                                                                                                     |
| ---: | ----: | -------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0.0% | 374 B | `http://atq.ck.valuecommerce.com/servlet/atq/refer…`     | `.expanded_url Object ← [0] Array (1) ← .urls Object ← .entities Object ← [42] Array (100) ← .statuses Object ← .data Object ← .__retained GlobalObject` |
| 0.0% | 336 B | `ROMって楽しんでいる部分もあり無言フォロー多めですすみません…。ツイート数多め・あらぶり多めなの…`     | `.description Object ← .user Object ← [25] Array (100) ← .statuses Object ← .data Object ← .__retained GlobalObject`                                     |
| 0.0% | 334 B | `ブリヂストンのスポーツタイヤ「POTENZA」のアカウントです。レースやタイヤの事などをつぶやきま…`     | `.description Object ← .user Object ← .retweeted_status Object ← [12] Array (100) ← .statuses Object ← .data Object ← .__retained GlobalObject`          |
| 0.0% | 334 B | `アッサム山中の趣味用アカ。当分の間、選挙啓発用としても使っていきます。このアカウントがアッサム山中…`     | `.description Object ← .user Object ← .retweeted_status Object ← [17] Array (100) ← .statuses Object ← .data Object ← .__retained GlobalObject`          |
| 0.0% | 332 B | `THE SECOND/劇団EXILE/EXILE/二代目JSB ☞KENCHI.AKIRA.青柳翔…`     | `.description Object ← .user Object ← [41] Array (100) ← .statuses Object ← .data Object ← .__retained GlobalObject`                                     |
| 0.0% | 326 B | `ﾟ.＊97line おさらに貢いでる系女子＊.゜                         …`     | `.description Object ← .user Object ← [8] Array (100) ← .statuses Object ← .data Object ← .__retained GlobalObject`                                      |
| 0.0% | 314 B | `ニコ動で踊り手やってます!!応援本当に嬉しいですありがとうございます!!　ぽっちゃりだけど前向きに…`     | `.description Object ← .user Object ← [99] Array (100) ← .statuses Object ← .data Object ← .__retained GlobalObject`                                     |
| 0.0% | 306 B | `【無断転載禁止･コピペ禁止・非公式RT禁止】【必読！】⇒ http://t.co/nuUvfUVD…`     | `.description Object ← .user Object ← [57] Array (100) ← .statuses Object ← .data Object ← .__retained GlobalObject`                                     |
| 0.0% | 304 B | `bot遊びと実況が主目的の趣味アカウント。成人済♀。時々TLお騒がせします。リフォ率低いですがＦ／…`     | `.description Object ← .user Object ← [6] Array (100) ← .statuses Object ← .data Object ← .__retained GlobalObject`                                      |
| 0.0% | 304 B | `@aym0566x \n\n名前:前田あゆみ\n第一印象:なんか怖っ！\n今の印象:とりあえずキモい。噛み…` | `.text Object ← [0] Array (100) ← .statuses Object ← .data Object ← .__retained GlobalObject`                                                            |
| 0.0% | 298 B | `ヤー・チャイカ。紫宝勢の末席くらいでQMAやってます。\n9/13（土）「九州杯」今年も宜しくお願…`    | `.description Object ← .user Object ← [45] Array (100) ← .statuses Object ← .data Object ← .__retained GlobalObject`                                     |
| 0.0% | 298 B | `RT @AFmbsk: @samao21718 \n呼び方☞まおちゃん\n呼ばれ方☞あーちゃん\n第一印…`  | `.text Object ← [8] Array (100) ← .statuses Object ← .data Object ← .__retained GlobalObject`                                                            |
| 0.0% | 296 B | `RT @shiawaseomamori: 一に止まると書いて、正しいという意味だなんて、この年にな…`     | `.text Object ← [48] Array (100) ← .statuses Object ← .data Object ← .__retained GlobalObject`                                                           |
| 0.0% | 296 B | `RT @shiawaseomamori: 一に止まると書いて、正しいという意味だなんて、この年にな…`     | `.text Object ← [61] Array (100) ← .statuses Object ← .data Object ← .__retained GlobalObject`                                                           |
| 0.0% | 296 B | `RT @shiawaseomamori: 一に止まると書いて、正しいという意味だなんて、この年にな…`     | `.text Object ← [54] Array (100) ← .statuses Object ← .data Object ← .__retained GlobalObject`                                                           |
| 0.0% | 296 B | `一に止まると書いて、正しいという意味だなんて、この年になるまで知りませんでした。 人は生きていると…`     | `.text Object ← .retweeted_status Object ← [54] Array (100) ← .statuses Object ← .data Object ← .__retained GlobalObject`                                |
| 0.0% | 296 B | `RT @shiawaseomamori: 一に止まると書いて、正しいという意味だなんて、この年にな…`     | `.text Object ← [52] Array (100) ← .statuses Object ← .data Object ← .__retained GlobalObject`                                                           |
| 0.0% | 296 B | `一に止まると書いて、正しいという意味だなんて、この年になるまで知りませんでした。 人は生きていると…`     | `.text Object ← .retweeted_status Object ← [52] Array (100) ← .statuses Object ← .data Object ← .__retained GlobalObject`                                |
| 0.0% | 296 B | `RT @shiawaseomamori: 一に止まると書いて、正しいという意味だなんて、この年にな…`     | `.text Object ← [51] Array (100) ← .statuses Object ← .data Object ← .__retained GlobalObject`                                                           |
| 0.0% | 296 B | `一に止まると書いて、正しいという意味だなんて、この年になるまで知りませんでした。 人は生きていると…`     | `.text Object ← .retweeted_status Object ← [51] Array (100) ← .statuses Object ← .data Object ← .__retained GlobalObject`                                |
