...
|  3.8% | 0.4ms |       1 | `run`         | node:internal/modules/esm/module_job |
...
|      % |  Time | Samples | Caller | Location                             |
| -----: | ----: | ------: | ------ | ------------------------------------ |
| 100.0% | 2.8ms |       1 | `run`  | node:internal/modules/esm/module_job |
...
|     % |    Time | Samples | Function                 | Location                             |
| ----: | ------: | ------: | ------------------------ | ------------------------------------ |
| 97.5% |   1.16s |     247 | `run`                    | node:internal/modules/esm/module_job |
...
| -----: | ----: | ------: | ------------- | ------------------------------- |
| 100.0% | 1.16s |     245 | `(anonymous)` | uneval/scripts/profile-pprof.ts |
|   0.0% | 0.4ms |       1 | `uneval`      | uneval/src/index.ts             |
...
| ---: | ------: | ------: | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 8.4% | 100.6ms |       1 | `traverseObject` (uneval/src/index.ts) ← `traverse` (uneval/src/index.ts) ← `createState` (uneval/src/index.ts) ← `uneval` (uneval/src/index.ts) ← `(anonymous)` (uneval/scripts/profile-pprof.ts) ← `run` (node:internal/modules/esm/module_job)                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| 7.2% |  86.4ms |       1 | `unevalObjectLike` (uneval/src/internal/object.ts) ← `unevalObjectInternal` (uneval/src/internal/object.ts) ← `unevalObject` (uneval/src/internal/object.ts) ← `unevalInternal` (uneval/src/internal/index.ts) ← `uneval` (uneval/src/index.ts) ← `(anonymous)` (uneval/scripts/profile-pprof.ts) ← `run` (node:internal/modules/esm/module_job)                                                                                                                                                                                                                                                                                                                                    |
| 6.1% |  73.2ms |       1 | `traverseObject` (uneval/src/index.ts) ← `traverse` (uneval/src/index.ts) ← `traverseObject` (uneval/src/index.ts) ← `traverse` (uneval/src/index.ts) ← `createState` (uneval/src/index.ts) ← `uneval` (uneval/src/index.ts) ← `(anonymous)` (uneval/scripts/profile-pprof.ts) ← `run` (node:internal/modules/esm/module_job)                                                                                                                                                                                                                                                                                                                                                       |
| 3.9% |  46.2ms |       1 | `unevalObjectInternal` (uneval/src/internal/object.ts) ← `unevalObject` (uneval/src/internal/object.ts) ← `unevalInternal` (uneval/src/internal/index.ts) ← `uneval` (uneval/src/index.ts) ← `(anonymous)` (uneval/scripts/profile-pprof.ts) ← `run` (node:internal/modules/esm/module_job)                                                                                                                                                                                                                                                                                                                                                                                         |
| 3.7% |  44.6ms |       1 | `unevalWithoutCustom` (uneval/src/internal/index.ts) ← `unevalObjectLiteralKey` (uneval/src/internal/object.ts) ← `unevalObjectLike` (uneval/src/internal/object.ts) ← `unevalObjectInternal` (uneval/src/internal/object.ts) ← `unevalObject` (uneval/src/internal/object.ts) ← `unevalInternal` (uneval/src/internal/index.ts) ← `uneval` (uneval/src/index.ts) ← `(anonymous)` (uneval/scripts/profile-pprof.ts) ← `run` (node:internal/modules/esm/module_job)                                                                                                                                                                                                                  |
...
| 2.8% |  33.1ms |       1 | `unevalArray` (uneval/src/internal/collection.ts) ← `unevalObjectInternal` (uneval/src/internal/object.ts) ← `unevalObject` (uneval/src/internal/object.ts) ← `unevalInternal` (uneval/src/internal/index.ts) ← `uneval` (uneval/src/index.ts) ← `(anonymous)` (uneval/scripts/profile-pprof.ts) ← `run` (node:internal/modules/esm/module_job)                                                                                                                                                                                                                                                                                                                                     |
| 2.6% |  31.5ms |       1 | `createState` (uneval/src/index.ts) ← `uneval` (uneval/src/index.ts) ← `(anonymous)` (uneval/scripts/profile-pprof.ts) ← `run` (node:internal/modules/esm/module_job)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| 2.6% |  30.8ms |       1 | `traverse` (uneval/src/index.ts) ← `traverseObject` (uneval/src/index.ts) ← `traverse` (uneval/src/index.ts) ← `createState` (uneval/src/index.ts) ← `uneval` (uneval/src/index.ts) ← `(anonymous)` (uneval/scripts/profile-pprof.ts) ← `run` (node:internal/modules/esm/module_job)                                                                                                                                                                                                                                                                                                                                                                                                |
| 2.4% |  29.3ms |       1 | `unevalLiteral` (uneval/src/internal/primitive.ts) ← `unevalString` (uneval/src/internal/primitive.ts) ← `unevalInternal` (uneval/src/internal/index.ts) ← `unevalWithoutCustom` (uneval/src/internal/index.ts) ← `unevalObjectLiteralKey` (uneval/src/internal/object.ts) ← `unevalObjectLike` (uneval/src/internal/object.ts) ← `unevalObjectInternal` (uneval/src/internal/object.ts) ← `unevalObject` (uneval/src/internal/object.ts) ← `unevalInternal` (uneval/src/internal/index.ts) ← `uneval` (uneval/src/index.ts) ← `(anonymous)` (uneval/scripts/profile-pprof.ts) ← `run` (node:internal/modules/esm/module_job)                                                       |
| 2.3% |  28.0ms |       1 | `Garbage Collection` ← `Node.js`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| 2.3% |  27.9ms |       1 | `unevalObjectLiteralKey` (uneval/src/internal/object.ts) ← `unevalObjectLike` (uneval/src/internal/object.ts) ← `unevalObjectInternal` (uneval/src/internal/object.ts) ← `unevalObject` (uneval/src/internal/object.ts) ← `unevalInternal` (uneval/src/internal/index.ts) ← `uneval` (uneval/src/index.ts) ← `(anonymous)` (uneval/scripts/profile-pprof.ts) ← `run` (node:internal/modules/esm/module_job)                                                                                                                                                                                                                                                                         |
| 2.1% |  25.7ms |       1 | `traverseObject` (uneval/src/index.ts) ← `traverse` (uneval/src/index.ts) ← `traverseObject` (uneval/src/index.ts) ← `traverse` (uneval/src/index.ts) ← `traverseObject` (uneval/src/index.ts) ← `traverse` (uneval/src/index.ts) ← `createState` (uneval/src/index.ts) ← `uneval` (uneval/src/index.ts) ← `(anonymous)` (uneval/scripts/profile-pprof.ts) ← `run` (node:internal/modules/esm/module_job)                                                                                                                                                                                                                                                                           |
| 2.1% |  25.1ms |       1 | `getType` (uneval/src/internal/type.ts) ← `traverseObject` (uneval/src/index.ts) ← `traverse` (uneval/src/index.ts) ← `createState` (uneval/src/index.ts) ← `uneval` (uneval/src/index.ts) ← `(anonymous)` (uneval/scripts/profile-pprof.ts) ← `run` (node:internal/modules/esm/module_job)                                                                                                                                                                                                                                                                                                                                                                                         |
...
| 1.6% |  19.7ms |       1 | `traverse` (uneval/src/index.ts) ← `createState` (uneval/src/index.ts) ← `uneval` (uneval/src/index.ts) ← `(anonymous)` (uneval/scripts/profile-pprof.ts) ← `run` (node:internal/modules/esm/module_job)                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| 1.6% |  19.6ms |       1 | `traverse` (uneval/src/index.ts) ← `traverseObject` (uneval/src/index.ts) ← `traverse` (uneval/src/index.ts) ← `traverseObject` (uneval/src/index.ts) ← `traverse` (uneval/src/index.ts) ← `createState` (uneval/src/index.ts) ← `uneval` (uneval/src/index.ts) ← `(anonymous)` (uneval/scripts/profile-pprof.ts) ← `run` (node:internal/modules/esm/module_job)                                                                                                                                                                                                                                                                                                                    |
