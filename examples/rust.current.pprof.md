...
|  4.0% |  7.0ms |       5 | `core::ptr::drop_in_place<alloc::vec::Vec<compiler::phases::backend::ir::Statement>>` (../../.rustup/toolchains/stable-aarch64-apple-darwin/lib/rustlib/src/rust/library/core/src/ptr/mod.rs) ← `compiler::phases::backend::code_gen::generate_code` (web-lang/compiler/src/phases/backend/code_gen.rs) ← `compiler::phases::backend::run_backend` (web-lang/compiler/src/phases/backend/mod.rs)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
