...
Allocated 717 MB over 865 samples → 872 samples (829 kB → 822 kB per sample).
...
Retained 19.9 MB → 20.1 MB (+0.2 MB, +0.7%) over 200 samples → 198 samples (99.6 kB → 101 kB per sample).
