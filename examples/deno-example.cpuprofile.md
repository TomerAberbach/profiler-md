...
| ------: | ----: | -------------------------- |
|   42.1% | 3,022 | src/internal/object.ts:144 |
|   30.5% | 2,189 | src/internal/object.ts:93  |
|    8.0% |   573 | src/internal/object.ts:99  |
|    5.7% |   411 | src/internal/object.ts:100 |
|    4.1% |   296 | src/internal/object.ts:83  |

##### `traverseObject` (src/index.ts:204:26)

| Count % | Count | Location         |
| ------: | ----: | ---------------- |
|   43.0% | 2,960 | src/index.ts:152 |
|   21.9% | 1,509 | src/index.ts:160 |
|   12.7% |   874 | src/index.ts:184 |
|    6.9% |   478 | src/index.ts:150 |
|    3.6% |   246 | src/index.ts:187 |

##### `unevalObjectInternal` (src/internal/object.ts:68:30)

| Count % | Count | Location                  |
| ------: | ----: | ------------------------- |
|   89.3% | 3,659 | src/internal/object.ts:54 |
|    5.9% |   243 | src/internal/object.ts:52 |
|    2.5% |   103 | src/internal/object.ts:48 |
|    1.4% |    56 | src/internal/object.ts:53 |
|    0.7% |    29 | src/internal/object.ts:50 |

##### `unevalLiteral` (src/internal/primitive.ts:139:23)

| Count % | Count | Location                      |
| ------: | ----: | ----------------------------- |
|   27.0% | 1,097 | src/internal/primitive.ts:105 |
|   25.0% | 1,013 | src/internal/primitive.ts:103 |
|   12.6% |   513 | src/internal/primitive.ts:104 |
|   11.9% |   484 | src/internal/primitive.ts:111 |
|    9.5% |   386 | src/internal/primitive.ts:136 |

##### `unevalWithoutCustom` (src/internal/index.ts:14:37)

| Count % | Count | Location                |
| ------: | ----: | ----------------------- |
|  100.0% | 3,990 | src/internal/index.ts:4 |

##### `unevalNumber` (src/internal/primitive.ts:12:29)

| Count % | Count | Location                     |
| ------: | ----: | ---------------------------- |
|   93.7% | 3,010 | src/internal/primitive.ts:15 |
|    3.8% |   123 | src/internal/primitive.ts:19 |
|    1.3% |    43 | src/internal/primitive.ts:7  |
|    0.5% |    17 | src/internal/primitive.ts:9  |
|    0.5% |    15 | src/internal/primitive.ts:11 |

##### `traverse` (src/index.ts:164:20)

| Count % | Count | Location         |
| ------: | ----: | ---------------- |
|   28.8% |   831 | src/index.ts:122 |
|   24.5% |   706 | src/index.ts:142 |
|   15.4% |   445 | src/index.ts:141 |
|   11.0% |   317 | src/index.ts:127 |
|   10.0% |   290 | src/index.ts:108 |

##### `unevalArray` (src/internal/collection.ts:7:47)

| Count % | Count | Location                      |
| ------: | ----: | ----------------------------- |
|   72.5% | 2,035 | src/internal/collection.ts:69 |
|    7.4% |   208 | src/internal/collection.ts:37 |
|    5.3% |   148 | src/internal/collection.ts:46 |
|    5.1% |   143 | src/internal/collection.ts:6  |
|    4.1% |   115 | src/internal/collection.ts:47 |

##### `unevalInternal` (src/internal/index.ts:25:32)

| Count % | Count | Location                 |
| ------: | ----: | ------------------------ |
|   44.2% |   938 | src/internal/index.ts:9  |
|    9.9% |   209 | src/internal/index.ts:16 |
|    9.7% |   206 | src/internal/index.ts:8  |
|    7.0% |   149 | src/internal/index.ts:19 |
|    6.9% |   147 | src/internal/index.ts:5  |

##### `getType` (src/internal/type.ts:4:24)

| Count % | Count | Location                |
| ------: | ----: | ----------------------- |
|   74.3% | 1,171 | src/internal/type.ts:11 |
|   23.0% |   363 | src/internal/type.ts:3  |
|    2.0% |    32 | src/internal/type.ts:4  |
|    0.3% |     5 | src/internal/type.ts:12 |
|    0.3% |     4 | src/internal/type.ts:13 |

##### `unevalObjectLiteralKey` (src/internal/object.ts:384:32)

| Count % | Count | Location                   |
| ------: | ----: | -------------------------- |
|   33.3% |   448 | src/internal/object.ts:284 |
|   23.0% |   310 | src/internal/object.ts:296 |
|   15.7% |   211 | src/internal/object.ts:285 |
|    9.3% |   125 | src/internal/object.ts:275 |
|    8.2% |   110 | src/internal/object.ts:283 |

##### `createState` (src/index.ts:144:21)

| Count % | Count | Location         |
| ------: | ----: | ---------------- |
|   20.9% |   240 | src/index.ts:249 |
|   18.2% |   210 | src/index.ts:93  |
|   16.2% |   186 | src/index.ts:106 |
|   14.5% |   167 | src/index.ts:92  |
|   13.6% |   156 | src/index.ts:94  |

##### `unevalObject` (src/internal/object.ts:20:29)

| Count % | Count | Location                  |
| ------: | ----: | ------------------------- |
|   40.2% |   136 | src/internal/object.ts:12 |
|   29.9% |   101 | src/internal/object.ts:16 |
|   19.5% |    66 | src/internal/object.ts:19 |
|    5.6% |    19 | src/internal/object.ts:17 |
|    4.1% |    14 | src/internal/object.ts:14 |

##### `isObject` (src/internal/object.ts:434:25)

| Count % | Count | Location                   |
| ------: | ----: | -------------------------- |
|   73.1% |   226 | src/internal/object.ts:309 |
|   26.9% |    83 | src/internal/object.ts:308 |

##### `unevalString` (src/internal/primitive.ts:133:29)

| Count % | Count | Location                     |
| ------: | ----: | ---------------------------- |
|  100.0% |   308 | src/internal/primitive.ts:97 |

##### `uneval` (src/index.ts:75:16)

| Count % | Count | Location        |
| ------: | ----: | --------------- |
|   80.1% |   233 | src/index.ts:36 |
|   13.1% |    38 | src/index.ts:34 |
|    3.4% |    10 | src/index.ts:40 |
|    2.1% |     6 | src/index.ts:43 |
|    1.4% |     4 | src/index.ts:35 |
