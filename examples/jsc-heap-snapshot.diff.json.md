...
| object   |  +0.0% |     +3 B |  745 kB |  745 kB |           8,886 |
...
| built-in |  +0.0% |    +65 B |  203 kB |  203 kB |           1,013 |
| array    |  +1.3% |   +848 B | 64.9 kB | 65.8 kB |   3,731 → 3,748 |
| regexp   |   0.0% |      0 B | 6.14 kB | 6.14 kB |             128 |
| unknown  |  +0.9% |    +38 B | 4.24 kB | 4.28 kB |       120 → 122 |
| symbol   |   0.0% |      0 B |  1.1 kB |  1.1 kB |              67 |
| number   |   0.0% |      0 B |   383 B |   383 B |              11 |
| bigint   |   0.0% |      0 B |   238 B |   238 B |              12 |
...
|   +0.0% |    +64 B |  170 kB |  170 kB |             761 | `Set`                        |
...
|   Change |    Delta |    Base | Current |       Instances | Constructor                 |
| -------: | -------: | ------: | ------: | --------------: | --------------------------- |
|  +586.9% |  +386 kB | 65.8 kB |  452 kB |           1,549 | `GetterSetter`              |
...
| +7785.7% |  +175 kB | 2.25 kB |  177 kB |              11 | `Intl.DurationFormat`       |
|  +817.5% |  +135 kB | 16.6 kB |  152 kB |             128 | `RegExp`                    |
|   +21.1% |  +128 kB |  607 kB |  735 kB |   3,427 → 4,615 | `PropertyTable`             |
|  +420.4% |  +125 kB | 29.8 kB |  155 kB |             554 | `HTMLSpanElement`           |
|    +9.8% |  +123 kB | 1.26 MB | 1.38 MB | 19,091 → 19,126 | `Function`                  |
| +1306.1% |  +123 kB |  9.4 kB |  132 kB |             137 | `SVGGElement`               |
|   +94.0% |  +104 kB |  111 kB |  215 kB |           3,618 | `Array`                     |
|  +242.5% | +56.3 kB | 23.2 kB | 79.6 kB |             521 | `DOMRect`                   |
|  +610.8% | +52.8 kB | 8.64 kB | 61.4 kB |              42 | `HTMLUListElement`          |
|   +68.2% |   +48 kB | 70.3 kB |  118 kB |             729 | `pe`                        |
|   +35.6% | +35.2 kB |   99 kB |  134 kB |             863 | `NativeExecutable`          |
|   +34.6% | +34.8 kB |  101 kB |  135 kB |           1,009 | `FunctionRareData`          |
|    +0.9% | +23.8 kB | 2.69 MB | 2.72 MB | 24,070 → 24,020 | `Structure`                 |
|  +951.4% | +19.5 kB | 2.05 kB | 21.5 kB |              22 | `Callee`                    |
|   +57.3% | +14.8 kB | 25.9 kB | 40.7 kB |             420 | `HTMLAnchorElement`         |
|  +630.1% | +14.8 kB | 2.35 kB | 17.2 kB |              32 | `MutationObserver`          |
...
| -99.6% |  -107 kB |  108 kB |   421 B |               9 | `JSSourceCode`               |
| -46.5% | -99.5 kB |  214 kB |  115 kB |           1,697 | `HTMLDivElement`             |
| -65.3% |   -97 kB |  148 kB | 51.5 kB |           1,130 | `Text`                       |
| -97.6% | -76.6 kB | 78.5 kB | 1.91 kB |         10 → 11 | `DocumentFragment`           |
| -96.2% | -76.6 kB | 79.6 kB | 3.06 kB |              18 | `HTMLLinkElement`            |
| -85.4% | -75.5 kB | 88.3 kB | 12.9 kB |              54 | `DOMPoint`                   |
|  -8.6% | -49.1 kB |  569 kB |  520 kB |           5,787 | `Object`                     |
| -92.6% | -15.5 kB | 16.7 kB | 1.24 kB |              22 | `InjectedScriptHost`         |
| -48.4% | -14.1 kB | 29.2 kB |   15 kB |             271 | `SVGLineElement`             |
| -90.6% | -13.5 kB | 14.9 kB | 1.41 kB |              21 | `HTMLHtmlElement`            |
| -95.8% | -13.3 kB | 13.9 kB |   576 B |               9 | `ScrubbingSupport`           |
|  -2.6% | -12.4 kB |  480 kB |  467 kB |   3,093 → 3,123 | `UnlinkedFunctionExecutable` |
| -86.1% | -11.6 kB | 13.5 kB | 1.87 kB |               9 | `SeekForwardSupport`         |
| -86.6% | -11.4 kB | 13.1 kB | 1.76 kB |               9 | `StatusSupport`              |
| -83.7% | -10.8 kB | 12.9 kB |  2.1 kB |               9 | `SkipForwardSupport`         |
