...
Allocated 39.9 GB → 40 GB (+0.1 GB, +0.3%) over 1,980 samples → 1,998 samples (20.2 MB → 20 MB per sample).

| Category | Change |   Delta |             % |              Size |       Samples |
| -------- | -----: | ------: | ------------: | ----------------: | ------------: |
| stdlib   |  +1.6% | +587 MB | 94.6% → 95.8% | 37.8 GB → 38.3 GB | 1,868 → 1,887 |
| ours     | -21.5% | -466 MB |   5.4% → 4.2% |  2.16 GB → 1.7 GB |     111 → 109 |
...
| +1120.0% |   +30 MB | <0.1% → 0.1% | 2.68 MB → 32.7 MB |   3 → 5 | `vectorSum()`              | org.renaissance.jdk.concurrent.JavaKMeans$VectorSumTask |
|    +2.9% | +2.75 MB |         0.2% | 93.7 MB → 96.5 MB |   5 → 6 | `merge(Map, Map)`          | org.renaissance.jdk.concurrent.JavaKMeans               |
|   +11.9% | +1.16 MB |        <0.1% | 9.78 MB → 10.9 MB | 26 → 29 | `valueOf(double)`          | java.lang.Double                                        |
|      new |  +802 kB | 0.0% → <0.1% |      0 B → 802 kB |   0 → 1 | `createSubtask(int, int)`  | org.renaissance.jdk.concurrent.JavaKMeans$UpdateTask    |
...
| Change |    Delta |            % |              Size | Samples | Function                             | Location                                                 |
| -----: | -------: | -----------: | ----------------: | ------: | ------------------------------------ | -------------------------------------------------------- |
| -95.0% |  -166 MB | 0.4% → <0.1% |  175 MB → 8.75 MB |   9 → 4 | `lambda$merge$6(List, List)`         | org.renaissance.jdk.concurrent.JavaKMeans                |
| -91.0% |  -116 MB | 0.3% → <0.1% |  127 MB → 11.5 MB |   6 → 3 | `collectClusters(int[])`             | org.renaissance.jdk.concurrent.JavaKMeans$AssignmentTask |
...
| -93.0% | -92.2 MB | 0.2% → <0.1% | 99.1 MB → 6.89 MB |   4 → 1 | `add(double[], double[])`            | org.renaissance.jdk.concurrent.JavaKMeans$VectorSumTask  |
...
|  -2.8% |  -116 kB |        <0.1% | 4.09 MB → 3.98 MB | 11 → 10 | `lambda$generateData$4(int)`         | org.renaissance.jdk.concurrent.JavaKMeans                |
...
|    +0.8% |  +254 MB | 84.1% → 84.4% | 33.6 GB → 33.8 GB | 1,526 → 1,557 | `apply(Object, Object)`                          | org.renaissance.jdk.concurrent.JavaKMeans$$Lambda.0x000000b801205218 |
...
|    +0.8% |  +254 MB | 84.1% → 84.4% | 33.6 GB → 33.8 GB | 1,526 → 1,557 | `accept(Object, Object)`                         | org.renaissance.jdk.concurrent.JavaKMeans$$Lambda.0x000000b801204d88 |
...
|    +0.3% |  +121 MB |         99.4% | 39.7 GB → 39.8 GB | 1,856 → 1,872 | `compute()`                                      | org.renaissance.jdk.concurrent.JavaKMeans$RangedTask                 |
|    +1.6% | +66.7 MB | 10.5% → 10.7% | 4.21 GB → 4.27 GB |     242 → 218 | `collectClusters(int[])`                         | org.renaissance.jdk.concurrent.JavaKMeans$AssignmentTask             |
|   +63.9% |   +46 MB |   0.2% → 0.3% |    72 MB → 118 MB |         3 → 9 | `createSubtask(int, int)`                        | org.renaissance.jdk.concurrent.JavaKMeans$VectorSumTask              |
|   +46.6% | +30.7 MB |          0.2% | 65.8 MB → 96.5 MB |         4 → 9 | `computeClusterAverages()`                       | org.renaissance.jdk.concurrent.JavaKMeans$UpdateTask                 |
|   +46.6% | +30.7 MB |          0.2% | 65.8 MB → 96.5 MB |         4 → 9 | `computeDirectly()`                              | org.renaissance.jdk.concurrent.JavaKMeans$UpdateTask                 |
| +1120.0% |   +30 MB |  <0.1% → 0.1% | 2.68 MB → 32.7 MB |         3 → 5 | `vectorSum()`                                    | org.renaissance.jdk.concurrent.JavaKMeans$VectorSumTask              |
| +1120.0% |   +30 MB |  <0.1% → 0.1% | 2.68 MB → 32.7 MB |         3 → 5 | `computeDirectly()`                              | org.renaissance.jdk.concurrent.JavaKMeans$VectorSumTask              |
|   +11.9% | +1.16 MB |         <0.1% | 9.78 MB → 10.9 MB |       26 → 29 | `valueOf(double)`                                | java.lang.Double                                                     |
|   +11.9% | +1.16 MB |         <0.1% | 9.78 MB → 10.9 MB |       26 → 29 | `lambda$generateData$3(int, int, Random[], int)` | org.renaissance.jdk.concurrent.JavaKMeans                            |
...
|  -94.8% |  -167 MB |  0.4% → <0.1% |  176 MB → 9.14 MB |            14 | `<clinit>()`                                   | scala.Predef$                                                                       |
|   -1.8% |  -150 MB | 20.6% → 20.2% | 8.23 GB → 8.08 GB |     186 → 222 | `lambda$run$0(int, List, int)`                 | org.renaissance.jdk.concurrent.JavaKMeans                                           |
|   -1.8% |  -150 MB | 20.6% → 20.2% | 8.23 GB → 8.08 GB |     186 → 222 | `call()`                                       | org.renaissance.jdk.concurrent.JavaKMeans$$Lambda.0x000000b8011ffbc0                |
|  -32.0% |  -110 MB |   0.9% → 0.6% |   343 MB → 233 MB |         7 → 8 | `createSubtask(int, int)`                      | org.renaissance.jdk.concurrent.JavaKMeans$AssignmentTask                            |
|   -8.9% |  -104 MB |   2.9% → 2.7% | 1.17 GB → 1.07 GB |       56 → 58 | `findNearestCentroid()`                        | org.renaissance.jdk.concurrent.JavaKMeans$AssignmentTask                            |
|  -93.0% | -92.2 MB |  0.2% → <0.1% | 99.1 MB → 6.89 MB |         4 → 1 | `add(double[], double[])`                      | org.renaissance.jdk.concurrent.JavaKMeans$VectorSumTask                             |
|  -93.0% | -92.2 MB |  0.2% → <0.1% | 99.1 MB → 6.89 MB |         4 → 1 | `combineResults(double[], double[])`           | org.renaissance.jdk.concurrent.JavaKMeans$VectorSumTask                             |
|  -93.0% | -92.2 MB |  0.2% → <0.1% | 99.1 MB → 6.89 MB |         4 → 1 | `combineResults(Object, Object)`               | org.renaissance.jdk.concurrent.JavaKMeans$VectorSumTask                             |
|  -31.8% | -83.7 MB |   0.7% → 0.4% |   263 MB → 180 MB |        16 → 7 | `computeIfAbsent(Object, Function)`            | java.util.HashMap                                                                   |
|  -33.0% | -45.7 MB |   0.3% → 0.2% |    139 MB → 93 MB |        10 → 6 | `<init>(Map)`                                  | java.util.HashMap                                                                   |
|  -63.0% | -41.5 MB |   0.2% → 0.1% | 65.8 MB → 24.3 MB |         4 → 7 | `average(List)`                                | org.renaissance.jdk.concurrent.JavaKMeans$UpdateTask                                |
|   -0.7% | -37.7 MB | 13.5% → 13.3% | 5.38 GB → 5.34 GB |     298 → 276 | `computeDirectly()`                            | org.renaissance.jdk.concurrent.JavaKMeans$AssignmentTask                            |
|  -38.3% | -28.9 MB |   0.2% → 0.1% | 75.6 MB → 46.6 MB |         7 → 2 | `lambda$collectClusters$0(Double[])`           | org.renaissance.jdk.concurrent.JavaKMeans$AssignmentTask                            |
|  -38.3% | -28.9 MB |   0.2% → 0.1% | 75.6 MB → 46.6 MB |         7 → 2 | `apply(Object)`                                | org.renaissance.jdk.concurrent.JavaKMeans$AssignmentTask$$Lambda.0x000000b801204b38 |
| removed |  -794 kB |  <0.1% → 0.0% |      794 kB → 0 B |         2 → 0 | `linkToTargetMethod(int, int, Object, Object)` | java.lang.invoke.LambdaForm$MH.0x000000c0011a2c00                                   |
|   -8.8% |  -587 kB |         <0.1% | 6.64 MB → 6.05 MB |       16 → 15 | `range(int, int)`                              | java.util.stream.IntStream                                                          |
|   -1.6% |  -415 kB |          0.1% | 26.8 MB → 26.3 MB |       70 → 69 | `apply(int)`                                   | org.renaissance.jdk.concurrent.JavaKMeans$$Lambda.0x000000b8011a18d8                |


# Retained heap profile diff

Retained 2.68 MB → 4.19 MB (+1.51 MB, +55.9%) over 10 samples → 17 samples (268 kB → 246 kB per sample).

| Category |  Change |   Delta |      % |              Size | Samples |
| -------- | ------: | ------: | -----: | ----------------: | ------: |
| stdlib   |  +55.9% | +1.5 MB | 100.0% | 2.68 MB → 4.19 MB |  9 → 14 |
...
|  Change |   Delta |            % |         Size | Samples | Function                            | Location                                                             |
| ------: | ------: | -----------: | -----------: | ------: | ----------------------------------- | -------------------------------------------------------------------- |
|     new | +1.5 MB | 0.0% → 35.9% | 0 B → 1.5 MB |   0 → 8 | `lambda$merge$6(List, List)`        | org.renaissance.jdk.concurrent.JavaKMeans                            |
|     new | +1.5 MB | 0.0% → 35.9% | 0 B → 1.5 MB |   0 → 8 | `apply(Object, Object)`             | org.renaissance.jdk.concurrent.JavaKMeans$$Lambda.0x000000b801205218 |
|     new | +1.5 MB | 0.0% → 35.9% | 0 B → 1.5 MB |   0 → 8 | `merge(Object, Object, BiFunction)` | java.util.HashMap                                                    |
|     new | +1.5 MB | 0.0% → 35.9% | 0 B → 1.5 MB |   0 → 8 | `lambda$merge$7(Map, Object, List)` | org.renaissance.jdk.concurrent.JavaKMeans                            |
|     new | +1.5 MB | 0.0% → 35.9% | 0 B → 1.5 MB |   0 → 8 | `accept(Object, Object)`            | org.renaissance.jdk.concurrent.JavaKMeans$$Lambda.0x000000b801204d88 |
|     new | +1.5 MB | 0.0% → 35.9% | 0 B → 1.5 MB |   0 → 8 | `forEach(BiConsumer)`               | java.util.HashMap                                                    |
|     new | +1.5 MB | 0.0% → 35.9% | 0 B → 1.5 MB |   0 → 8 | `merge(Map, Map)`                   | org.renaissance.jdk.concurrent.JavaKMeans                            |
|     new | +1.5 MB | 0.0% → 35.9% | 0 B → 1.5 MB |   0 → 8 | `combineResults(Map, Map)`          | org.renaissance.jdk.concurrent.JavaKMeans$AssignmentTask             |
|     new | +1.5 MB | 0.0% → 35.9% | 0 B → 1.5 MB |   0 → 8 | `combineResults(Object, Object)`    | org.renaissance.jdk.concurrent.JavaKMeans$AssignmentTask             |
|     new | +1.5 MB | 0.0% → 35.9% | 0 B → 1.5 MB |   0 → 8 | `compute()`                         | org.renaissance.jdk.concurrent.JavaKMeans$RangedTask                 |
|     new | +1.4 MB | 0.0% → 33.5% | 0 B → 1.4 MB |   0 → 7 | `addAll(Collection)`                | java.util.ArrayList                                                  |
|     new | +301 kB |  0.0% → 7.2% | 0 B → 301 kB |   0 → 2 | `join()`                            | java.util.concurrent.ForkJoinTask                                    |
|     new | +301 kB |  0.0% → 7.2% | 0 B → 301 kB |   0 → 2 | `invoke()`                          | java.util.concurrent.ForkJoinTask                                    |
|     new | +301 kB |  0.0% → 7.2% | 0 B → 301 kB |   0 → 2 | `lambda$run$0(int, List, int)`      | org.renaissance.jdk.concurrent.JavaKMeans                            |
|     new | +301 kB |  0.0% → 7.2% | 0 B → 301 kB |   0 → 2 | `call()`                            | org.renaissance.jdk.concurrent.JavaKMeans$$Lambda.0x000000b8011ffbc0 |
|     new | +100 kB |  0.0% → 2.4% | 0 B → 100 kB |   0 → 1 | `<init>(Collection)`                | java.util.ArrayList                                                  |
...
Blocked 7.01s → 7.40s (+0.39s, +5.6%) over 54 samples → 58 samples (129.8ms → 127.7ms per sample).

| Category | Change |    Delta |      % |          Time | Samples |
| -------- | -----: | -------: | -----: | ------------: | ------: |
| stdlib   |  +5.6% | +396.0ms | 100.0% | 7.01s → 7.40s | 54 → 58 |
...
|  +3.4% | +205.3ms | 86.4% → 84.5% | 6.05s → 6.26s |      16 | `apply(Object)`                                                                                                        | org.renaissance.jdk.concurrent.FjKmeans$$Lambda.0x000000b8011f6c70   |
...
|  +3.4% | +205.3ms | 86.4% → 84.5% | 6.05s → 6.26s |      16 | `applyVoid(Object)`                                                                                                    | org.renaissance.harness.RenaissanceSuite$$$Lambda.0x000000b801198798 |
...
|  +3.4% | +205.3ms | 86.4% → 84.5% | 6.05s → 6.26s |      16 | `main(String[])`                                                                                                       | org.renaissance.harness.RenaissanceSuite                             |
|  +3.4% | +205.3ms | 86.4% → 84.5% | 6.05s → 6.26s |      16 | `invoke(Object, Object[])`                                                                                             | java.lang.reflect.Method                                             |
|  +3.4% | +205.3ms | 86.4% → 84.5% | 6.05s → 6.26s |      16 | `loadAndInvokeHarnessClass(ModuleLoader, String, String[])`                                                            | org.renaissance.core.Launcher                                        |
|  +3.4% | +205.3ms | 86.4% → 84.5% | 6.05s → 6.26s |      16 | `launchHarnessClass(String, String[])`                                                                                 | org.renaissance.core.Launcher                                        |
|  +3.4% | +205.3ms | 86.4% → 84.5% | 6.05s → 6.26s |      16 | `main(String[])`                                                                                                       | org.renaissance.core.Launcher                                        |
