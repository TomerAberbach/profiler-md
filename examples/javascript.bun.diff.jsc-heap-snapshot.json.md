...
Allocated 1.53 MB (+1.505 kB, +0.1%) across 16,635 → 16,649 nodes and 45,015 → 45,184 edges.

| Category | Change |     Delta |             % |            Size |         Nodes |
| -------- | -----: | --------: | ------------: | --------------: | ------------: |
| code     |   0.0% |       0 B | 42.6% → 42.5% |          649 kB |         2,762 |
| string   |    ~0% |      +1 B |         23.9% |          364 kB |         6,250 |
| internal |  +0.5% | +1.504 kB | 20.1% → 20.2% | 307 kB → 309 kB | 3,121 → 3,135 |
...
| -----: | --------: | ------------: | ----------------: | ------------: | --------------- |
|  +0.7% | +1.456 kB | 13.3% → 13.4% |   203 kB → 205 kB | 1,816 → 1,829 | `Structure`     |
...
|  Change |     Delta |             % |            Size |     Instances | Constructor           |
| ------: | --------: | ------------: | --------------: | ------------: | --------------------- |
|   +0.3% | +1.503 kB | 31.8% → 31.9% | 486 kB → 487 kB |           931 | `FunctionExecutable`  |
|   +0.6% | +1.488 kB | 15.5% → 15.6% | 237 kB → 238 kB | 1,816 → 1,829 | `Structure`           |
...
| Change |      Delta |             % |              Size | Instances | Constructor         |
| -----: | ---------: | ------------: | ----------------: | --------: | ------------------- |
|  -6.8% | -92.924 kB | 89.1% → 82.9% | 1.36 MB → 1.27 MB |         1 | `GlobalObject`      |
|  -1.9% | -11.872 kB | 41.3% → 40.5% |   630 kB → 618 kB |     1,373 | `Object`            |
