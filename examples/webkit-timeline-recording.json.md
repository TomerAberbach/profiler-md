...
| -------- | ----: | ------: | ------: |
| stdlib   | 68.9% | 426.0ms |     386 |
| ours     | 30.9% | 191.1ms |     193 |
| program  |  0.2% |   1.0ms |       1 |
...
|  0.6% |   4.0ms |       4 | `(anonymous)`           | FormMetadata.js:3:11837                    |
...
|      % |  Time | Samples | Location          |
| -----: | ----: | ------: | ----------------- |
| 100.0% | 4.0ms |       4 | FormMetadata.js:3 |
...
|      % |  Time | Samples | Caller        | Location                |
| -----: | ----: | ------: | ------------- | ----------------------- |
| 100.0% | 4.0ms |       4 | `(anonymous)` | FormMetadata.js:3:14331 |
...
| 73.2% | 452.3ms |     411 | `bound Em`     | `<unknown>`                                |
...
|     % |    Time | Samples | Callee        | Location                                 |
| ----: | ------: | ------: | ------------- | ---------------------------------------- |
| 99.8% | 452.3ms |     411 | `bound Em`    | `<unknown>`                              |
...
|      % |    Time | Samples | Callee | Location                                 |
| -----: | ------: | ------: | ------ | ---------------------------------------- |
| 100.0% | 452.3ms |     411 | `Em`   | assets/entry.client-Ne_rep3S.js:1:138143 |
...
|    % |  Time | Samples | Callee      | Location                                    |
| ---: | ----: | ------: | ----------- | ------------------------------------------- |
| 0.6% | 1.0ms |       1 | `(program)` | __InjectedScript_ModernMediaControls.js:1:1 |
...
| ----: | ------: | ------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 19.2% | 118.4ms |      78 | `scrollTo` ← `(anonymous)` (assets/chunk-LFPYN7LY-CZBE6JVM.js:1:122230) ← `$u` (assets/entry.client-Ne_rep3S.js:1:100526) ← `xv` (1:106137) ← `Bt` (1:115066) ← `xv` (1:106137) ← `Bt` (1:115066) ← `xv` (1:106137) ← `Bt` (1:115066) ← `xv` (1:106137) ← `Bt` (1:115066) ← `xv` (1:106137) ← `Bt` (1:115066) ← `xv` (1:106137) ← `Bt` (1:115066) ← `xv` (1:106137) ← `Bt` (1:115066) ← `xv` (1:106137) ← `Bt` (1:115066) ← `xv` (1:106137) ← `Bt` (1:115066) ← `xv` (1:106137) ← `Bt` (1:115066) ← `xv` (1:106137) ← `Bt` (1:115066) ← `xv` (1:106137) ← `Bt` (1:115066) ← `xv` (1:106137) ← `Bt` (1:115066) ← `xv` (1:106137) ← `Bt` (1:115066) ← `xv` (1:106137) ← `Bt` (1:115066) ← `xv` (1:106137) ← `Bt` (1:115066) ← `xv` (1:106137) ← `Bt` (1:115066) ← `xv` (1:106137) ← `Bt` (1:115066) ← `xv` (1:106137) ← `Bt` (1:115066) ← `xv` (1:106137) ← `Bt` (1:115066) ← `xv` (1:106137) ← `Bt` (1:115066) ← `xv` (1:106137) ← `Bt` (1:115066) ← `xv` (1:106137) ← `hm` (1:133961) ← `ym` (1:129992) ← `um` (1:123565) ← `am` (1:121663) ← `Em` (1:138143) ← `bound Em` ← `Ra` (assets/entry.client-Ne_rep3S.js:1:1733)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| 17.8% | 110.0ms |     110 | `insertBefore` ← `mn` (assets/entry.client-Ne_rep3S.js:1:105658) ← `Bl` (1:114498) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `dm` (1:132714) ← `ym` (1:129992) ← `um` (1:123565) ← `am` (1:121663) ← `Em` (1:138143) ← `bound Em` ← `Ra` (assets/entry.client-Ne_rep3S.js:1:1733)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
|  5.3% |  33.0ms |      33 | `(anonymous)` (assets/deserialize-CTeepBb-.js:1:244) ← `wr` (assets/home-BLAXmiwx.js:1:125279) ← `(anonymous)` (1:124929) ← `(anonymous)` (assets/deserialize-CTeepBb-.js:1:560) ← `W` (1:1414) ← `bound ` ← `xe` (assets/deserialize-CTeepBb-.js:1:419) ← `ud` (assets/home-BLAXmiwx.js:1:123670) ← `Vf` (assets/entry.client-Ne_rep3S.js:1:56250) ← `ic` (1:76767) ← `im` (1:127356) ← `w1` (1:127314) ← `(anonymous)` (1:121766) ← `am` (1:121663) ← `Em` (1:138143) ← `bound Em` ← `Ra` (assets/entry.client-Ne_rep3S.js:1:1733)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
|  2.9% |  18.0ms |      18 | `forEach` ← `insertBefore` ← `mn` (assets/entry.client-Ne_rep3S.js:1:105658) ← `Bl` (1:114498) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `dm` (1:132714) ← `ym` (1:129992) ← `um` (1:123565) ← `am` (1:121663) ← `Em` (1:138143) ← `bound Em` ← `Ra` (assets/entry.client-Ne_rep3S.js:1:1733)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|  2.1% |  13.0ms |      13 | `(anonymous)` (assets/home-BLAXmiwx.js:1:118859) ← `(anonymous)` (1:119181) ← `$u` (assets/entry.client-Ne_rep3S.js:1:100526) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `Sm` (1:134865) ← `Am` (1:138472) ← `ue` (1:136637) ← `sm` (1:134150) ← `ym` (1:129992) ← `um` (1:123565) ← `am` (1:121663) ← `Em` (1:138143) ← `bound Em` ← `Ra` (assets/entry.client-Ne_rep3S.js:1:1733)                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
|  1.9% |  12.0ms |      12 | `getPropertyValue` ← `insertBefore` ← `mn` (assets/entry.client-Ne_rep3S.js:1:105658) ← `Bl` (1:114498) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `dm` (1:132714) ← `ym` (1:129992) ← `um` (1:123565) ← `am` (1:121663) ← `Em` (1:138143) ← `bound Em` ← `Ra` (assets/entry.client-Ne_rep3S.js:1:1733)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
|  1.9% |  12.0ms |      12 | `getPropertyValue` ← `(anonymous)` (assets/shrink-wrap-D0I1-yBi.js:1:2567) ← `forEach` ← `_processComputedStyle` (assets/shrink-wrap-D0I1-yBi.js:1:2479) ← `_handleUpdate` (1:2887) ← `observe` (1:1561) ← `(anonymous)` (1:3711) ← `$u` (assets/entry.client-Ne_rep3S.js:1:100526) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `it` (1:116768) ← `Wv` (1:116861) ← `Sm` (1:134865) ← `Am` (1:138472) ← `ue` (1:136637) ← `sm` (1:134150) ← `ym` (1:129992) ← `um` (1:123565) ← `am` (1:121663) ← `Em` (1:138143) ← `bound Em` ← `Ra` (assets/entry.client-Ne_rep3S.js:1:1733) |
|  1.8% |  11.0ms |      11 | `map` ← `insertBefore` ← `mn` (assets/entry.client-Ne_rep3S.js:1:105658) ← `Bl` (1:114498) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `dm` (1:132714) ← `ym` (1:129992) ← `um` (1:123565) ← `am` (1:121663) ← `Em` (1:138143) ← `bound Em` ← `Ra` (assets/entry.client-Ne_rep3S.js:1:1733)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
|  1.8% |  11.0ms |      11 | `getBoundingClientRect` ← `Ne` (assets/home-BLAXmiwx.js:1:16147) ← `Dr` (1:15240)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|  1.6% |  10.0ms |      10 | `(anonymous)` (assets/chunk-LFPYN7LY-CZBE6JVM.js:1:122137) ← `(anonymous)` (1:26765) ← `(anonymous)` (1:26687) ← `asyncFunctionResume` ← `Ue` (assets/chunk-LFPYN7LY-CZBE6JVM.js:1:26680) ← `(anonymous)` (1:39725) ← `asyncFunctionResume` ← `Ar` (assets/chunk-LFPYN7LY-CZBE6JVM.js:1:39720) ← `(anonymous)` (1:66459) ← `asyncFunctionResume` ← `(anonymous)` (assets/chunk-LFPYN7LY-CZBE6JVM.js:1:66449) ← `(anonymous)` (1:116360) ← `(anonymous)` (1:117018) ← `Om` (assets/entry.client-Ne_rep3S.js:1:140394) ← `(anonymous)` (1:142078) ← `Bi` (1:24177) ← `Zc` (1:141675) ← `Pc` (1:169323) ← `Bd` (1:169137)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|  0.8% |   5.1ms |       6 | `(anonymous)` (assets/entry.client-Ne_rep3S.js:1:142078) ← `Bi` (1:24177) ← `Zc` (1:141675) ← `Pc` (1:169323) ← `Yd` (1:169230)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|  0.6% |   4.0ms |       4 | `xn` (assets/chunk-LFPYN7LY-CZBE6JVM.js:1:83381) ← `(anonymous)` (1:85850) ← `asyncFunctionResume`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
|  0.6% |   4.0ms |       4 | `toLocaleDateString` ← `Je` (assets/post-DMDTSjRj.js:1:46948) ← `Vf` (assets/entry.client-Ne_rep3S.js:1:56250) ← `ic` (1:76767) ← `im` (1:127356) ← `w1` (1:127314) ← `(anonymous)` (1:121766) ← `am` (1:121663) ← `Em` (1:138143) ← `bound Em` ← `Ra` (assets/entry.client-Ne_rep3S.js:1:1733)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|  0.6% |   4.0ms |       4 | `setAttribute` ← `J` (assets/entry.client-Ne_rep3S.js:1:147819) ← `Tl` (1:153179) ← `p1` (1:93533) ← `bn` (1:129544) ← `im` (1:127356) ← `w1` (1:127314) ← `(anonymous)` (1:121766) ← `am` (1:121663) ← `Em` (1:138143) ← `bound Em` ← `Ra` (assets/entry.client-Ne_rep3S.js:1:1733)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
|  0.6% |   4.0ms |       4 | `(anonymous)` (FormMetadata.js:3:11837) ← `(anonymous)` (3:14331) ← `_collectFormMetadata` (3:62833) ← `_collectMetadata` (3:78950) ← `formsAndMetadata` (3:82286)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
|  0.5% |   3.0ms |       3 | `Bi` (assets/entry.client-Ne_rep3S.js:1:24177) ← `Zc` (1:141675) ← `Pc` (1:169323) ← `Yd` (1:169230)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
|  0.5% |   3.0ms |       3 | `at` (assets/post-DMDTSjRj.js:1:22685) ← `(anonymous)` (1:45390) ← `pr` (1:45171) ← `Vf` (assets/entry.client-Ne_rep3S.js:1:56250) ← `ic` (1:76767) ← `im` (1:127356) ← `w1` (1:127314) ← `(anonymous)` (1:121766) ← `am` (1:121663) ← `Em` (1:138143) ← `bound Em` ← `Ra` (assets/entry.client-Ne_rep3S.js:1:1733)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
|  0.5% |   3.0ms |       3 | `forEach` ← `map` ← `insertBefore` ← `mn` (assets/entry.client-Ne_rep3S.js:1:105658) ← `Bl` (1:114498) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `dm` (1:132714) ← `ym` (1:129992) ← `um` (1:123565) ← `am` (1:121663) ← `Em` (1:138143) ← `bound Em` ← `Ra` (assets/entry.client-Ne_rep3S.js:1:1733)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|  0.5% |   3.0ms |       3 | `getPropertyValue` ← `forEach`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
|  0.5% |   3.0ms |       3 | `removeChild` ← `rv` (assets/entry.client-Ne_rep3S.js:1:107820) ← `qt` (1:107755) ← `rv` (1:107820) ← `qt` (1:107755) ← `rv` (1:107820) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `ql` (1:109597) ← `Jv` (1:110080) ← `dm` (1:132714) ← `ym` (1:129992) ← `um` (1:123565) ← `am` (1:121663) ← `Em` (1:138143) ← `bound Em` ← `Ra` (assets/entry.client-Ne_rep3S.js:1:1733)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
