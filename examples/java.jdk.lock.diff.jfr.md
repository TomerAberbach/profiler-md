...
Allocated 40.5 GB → 40.6 GB (+0.1 GB, +0.3%) over 1,972 samples → 2,040 samples (20.5 MB → 19.9 MB per sample).
...
Retained 2.7 MB → 2.88 MB (+0.18 MB, +7.0%) over 13 samples → 10 samples (207 kB → 288 kB per sample).
...
Blocked 7.03s → 7.44s (+0.41s, +5.9%) over 54 samples → 58 samples (130.2ms → 128.4ms per sample).
