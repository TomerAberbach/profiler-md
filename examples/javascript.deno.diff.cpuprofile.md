...
| stdlib            |  -38.4% |  -90.4ms |   7.1% → 6.3% | 235.8ms → 145.3ms |      169 → 98 |
...
| regexp            | removed |   -1.3ms |  <0.1% → 0.0% |       1.3ms → 0ms |         2 → 0 |
...
| removed |  -1.3ms | <0.1% → 0.0% |     1.3ms → 0ms |   1 → 0 | `typeCheckProject`                               | tmp/nix-shell.RhDkiq/profiler-md-fixtures.0q5jPY/zod/tsc-workload.mjs:3:33 |
| removed |  -1.2ms | <0.1% → 0.0% |     1.2ms → 0ms |   1 → 0 | `RegExp: (?:\/\/)\|(?:^\|\/)\.\.?(?:$\|\/)`      | `<unknown>`                                                                |
|   -0.2% |  -0.1ms |  0.8% → 1.2% | 28.2ms → 28.1ms |       1 | `post`                                           | ext:deno_node/inspector.js:179:7                                           |
| removed |  -0.1ms | <0.1% → 0.0% |     0.1ms → 0ms |   1 → 0 | `RegExp: [^\u0130\u0131\u00DFa-z0-9\\/:\-_\. ]+` | `<unknown>`                                                                |
...
| -----: | ------: | ----------: | ----------------: | -------: | ---------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| +14.7% | +17.2ms | 3.5% → 5.8% | 117.0ms → 134.3ms | 96 → 110 | `(garbage collector)`              | `<unknown>`                                                                                                                                         |
|  +2.3% |  +0.6ms | 0.8% → 1.2% |   28.2ms → 28.9ms |    1 → 2 | `post`                             | ext:deno_node/inspector.js:179:7                                                                                                                    |
|  +2.3% |  +0.6ms | 0.8% → 1.2% |   28.2ms → 28.9ms |    1 → 2 | `(anonymous)`                      | tmp/nix-shell.RhDkiq/profiler-md-fixtures.0q5jPY/zod/cpuprofile-run.mjs:16:15                                                                       |
...
|  -32.2% | -782.2ms | 73.1% → 70.9% |     2.42s → 1.64s | 3,022 → 2,439 | `getSemanticDiagnostics`                         | private/tmp/nix-shell.RhDkiq/profiler-md-fixtures.0q5jPY/zod/node_modules/.deno/typescript@4.5.5/node_modules/typescript/lib/typescript.js:114663:40 |
...
|  -67.1% |  -85.0ms |   3.8% → 1.8% |  126.7ms → 41.7ms |      100 → 33 | `require`                                        | node:module:1752:35                                                                                                                                  |
|  -36.2% |  -10.6ms |   0.9% → 0.8% |   29.2ms → 18.6ms |       30 → 21 | `(program)`                                      | `<unknown>`                                                                                                                                          |
| removed |   -1.2ms |  <0.1% → 0.0% |       1.2ms → 0ms |         1 → 0 | `RegExp: (?:\/\/)\|(?:^\|\/)\.\.?(?:$\|\/)`      | `<unknown>`                                                                                                                                          |
| removed |   -0.1ms |  <0.1% → 0.0% |       0.1ms → 0ms |         1 → 0 | `RegExp: [^\u0130\u0131\u00DFa-z0-9\\/:\-_\. ]+` | `<unknown>`                                                                                                                                          |
