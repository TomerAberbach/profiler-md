...
Allocated 1.8 GB (-2.23 MB, -0.1%) and retained 2.19 MB → 1.66 MB (-529 kB, -24.1%) over 21,825,413 samples → 21,882,388 samples (82.4 B → 82.1 B and 0.10052510804721083 B → 0.07608840497664149 B per sample).

| Category | Change |    Delta |      % |             Size |              Size |                 Samples |
| -------- | -----: | -------: | -----: | ---------------: | ----------------: | ----------------------: |
| stdlib   |  -0.1% | -2.22 MB | 100.0% |           1.8 GB | 2.19 MB → 1.66 MB | 21,824,644 → 21,882,132 |
...
|  -35.1% |  -639 kB |         0.1% | 1.82 MB → 1.18 MB |                 81 → 87 | `main.main`               | Users/tomer/Documents/work/code/profiler-md/scripts/fixtures/assets/go/profile.go:61          |
