...
| -------- | -----: | -------: | -----: | ---------------: | ----------------: | --------: |
| stdlib   |  -0.1% | -2.22 MB | 100.0% |           1.8 GB | 2.19 MB → 1.66 MB | 490 → 460 |
...
|  -35.1% |  -639 kB |         0.1% | 1.82 MB → 1.18 MB |   31 → 37 | `main.main`               | Users/tomer/Documents/work/code/profiler-md/scripts/fixtures/assets/go/profile.go:61          |
