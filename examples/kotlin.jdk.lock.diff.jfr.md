...
Allocated 717 MB (+15.3 kB, ~0%) over 865 samples → 864 samples (829 kB → 830 kB per sample).
...
Retained 20.7 MB → 18.9 MB (-1.72 MB, -8.3%) over 203 samples → 196 samples (102 kB → 96.6 kB per sample).
