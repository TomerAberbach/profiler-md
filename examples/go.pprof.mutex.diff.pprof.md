...
|   -2.2% | -0.08ms |  2.3% → 2.2% | 3.6ms → 3.5ms | 546 → 582 | `main.workload.func1`              | `Users/tomer/Documents/work/code/profiler-md/scripts/fixtures/assets/go/profile.go:25`          |
...
| removed | -4.08µs | <0.1% → 0.0% |   4.1µs → 0ms |     1 → 0 | `main.writeProfile`                | `Users/tomer/Documents/work/code/profiler-md/scripts/fixtures/assets/go/profile.go:46`          |
| removed | -4.08µs | <0.1% → 0.0% |   4.1µs → 0ms |     1 → 0 | `main.main`                        | `Users/tomer/Documents/work/code/profiler-md/scripts/fixtures/assets/go/profile.go:61`          |
