...
|    % |    Size | Samples | Callee        | Location    |
| ---: | ------: | ------: | ------------- | ----------- |
| 0.1% | 1.41 kB |       8 | `POOL_create` | `<unknown>` |
...
|  0.9% | 1.31 MB |       6 | `AIO_IOPool_init` (fileio_asyncio.c) ← `AIO_ReadPool_create` ← `FIO_createCResources` (fileio.c) ← `_start`                                                                                                                                                                              |
|  0.4% |  527 kB |       2 | `AIO_IOPool_init` (fileio_asyncio.c) ← `AIO_WritePool_create` ← `FIO_createCResources` (fileio.c) ← `_start` ← `FIO_createCResources` (fileio.c)                                                                                                                                         |
|  0.3% |  395 kB |       4 | `AIO_IOPool_init` (fileio_asyncio.c) ← `AIO_WritePool_create` ← `FIO_createCResources` (fileio.c) ← `_start`                                                                                                                                                                             |
|  0.3% |  395 kB |       2 | `AIO_IOPool_init` (fileio_asyncio.c) ← `AIO_WritePool_create` ← `FIO_createCResources` (fileio.c) ← `_start` ← `_start`                                                                                                                                                                  |
