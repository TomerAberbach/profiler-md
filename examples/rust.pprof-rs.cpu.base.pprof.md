...
| -----: | ------: | ------: | ---------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| 100.0% |   4.27s |   4,275 | `json_bench::workload`                               | Users/tomer/Documents/work/code/profiler-md/scripts/fixtures/assets/rust/profile/src/profile.rs                                         |
| 100.0% |   4.27s |   4,275 | `json_bench::main`                                   | Users/tomer/Documents/work/code/profiler-md/scripts/fixtures/assets/rust/profile/src/profile.rs                                         |
