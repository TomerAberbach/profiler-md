...
|  0.0% |   0 B |       1 | `FIO_openSrcFile` (fileio.c) ← `FIO_compressFilename_srcFile`                                                                                                                 |
...
|  0.0% |   0 B |       2 | `AIO_IOPool_init` (fileio_asyncio.c) ← `AIO_WritePool_create` ← `FIO_createCResources` (fileio.c) ← `FIO_createCResources`                                                    |
|  0.0% |   0 B |       1 | `ZSTDMT_getBuffer` (zstdmt_compress.c) ← `ZSTDMT_compressionJob` ← `POOL_thread` (pool.c)                                                                                     |
|  0.0% |   0 B |       2 | `AIO_IOPool_init` (fileio_asyncio.c) ← `AIO_WritePool_create` ← `FIO_createCResources` (fileio.c)                                                                             |
