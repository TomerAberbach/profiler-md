...
| 77.0% |  591 MB | 5,802,917 | `(anonymous:L#1:C#1)`              | private/tmp/nix-shell.s3uqql/profiler-md-fixtures.pYM2jp/zod/datadog-pprof-heap.mjs                               |
...
|  2.0% | 15.6 MB |    88,994 | `require` (node:internal/modules/helpers) ← `typeCheckProject` (private/tmp/nix-shell.s3uqql/profiler-md-fixtures.pYM2jp/zod/tsc-workload.mjs) ← `(anonymous:L#1:C#1)` (private/tmp/nix-shell.s3uqql/profiler-md-fixtures.pYM2jp/zod/datadog-pprof-heap.mjs)                                                                                                   |
