...
| native       |   0.0% |      0 B |          0.0% |             328 B |             1 |
| regexp       |   0.0% |      0 B |          0.0% |              64 B |             2 |
| bigint       |   0.0% |      0 B |          0.0% |              32 B |             1 |
...
| -93.2% |   -880 B | 0.1% → 0.0% |    944 B → 64 B |         1 | `FixedCircularBuffer` |
| -42.6% |   -416 B | 0.1% → 0.0% |   976 B → 560 B |         1 | `FixedQueue`          |
