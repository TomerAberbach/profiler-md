...
|  2.6% |   0ms |       1 | `<init>(boolean)`                                | java.util.concurrent.locks.ReentrantReadWriteLock |
|  1.4% |   0ms |       1 | `getDeclaredMethods0(boolean)`                   | java.lang.Class                                   |
|  1.3% |   0ms |       1 | `walkFileTree(Path, Set, int, FileVisitor)`      | java.nio.file.Files                               |
|  1.2% |   0ms |       1 | `iterator(DirectoryStream)`                      | sun.nio.fs.UnixDirectoryStream                    |
|  1.1% |   0ms |       1 | `doubleStream(Spliterator$OfDouble, boolean)`    | java.util.stream.StreamSupport                    |
|  0.2% |   0ms |       1 | `preVisitDirectory(Object, BasicFileAttributes)` | java.nio.file.SimpleFileVisitor                   |
|  0.2% |   0ms |       1 | `<clinit>()`                                     | java.nio.file.FileTreeWalker$EventType            |
...
|      % | Time | Samples | Location                 |
| -----: | ---: | ------: | ------------------------ |
| 100.0% |  0ms |       1 | java.nio.file.Files:2791 |

##### `iterator(DirectoryStream)` (sun.nio.fs.UnixDirectoryStream)

|      % | Time | Samples | Location                           |
| -----: | ---: | ------: | ---------------------------------- |
| 100.0% |  0ms |       1 | sun.nio.fs.UnixDirectoryStream:119 |

##### `doubleStream(Spliterator$OfDouble, boolean)` (java.util.stream.StreamSupport)

|      % | Time | Samples | Location                           |
| -----: | ---: | ------: | ---------------------------------- |
| 100.0% |  0ms |       1 | java.util.stream.StreamSupport:274 |
...
|      % | Time | Samples | Location                                   |
| -----: | ---: | ------: | ------------------------------------------ |
| 100.0% |  0ms |       1 | java.nio.file.FileTreeWalker$EventType:121 |
...
|      % | Time | Samples | Caller                            | Location            |
| -----: | ---: | ------: | --------------------------------- | ------------------- |
| 100.0% |  0ms |       1 | `walkFileTree(Path, FileVisitor)` | java.nio.file.Files |

##### `iterator(DirectoryStream)` (sun.nio.fs.UnixDirectoryStream)

|      % | Time | Samples | Caller       | Location                       |
| -----: | ---: | ------: | ------------ | ------------------------------ |
| 100.0% |  0ms |       1 | `iterator()` | sun.nio.fs.UnixDirectoryStream |

##### `doubleStream(Spliterator$OfDouble, boolean)` (java.util.stream.StreamSupport)

|      % | Time | Samples | Caller                       | Location         |
| -----: | ---: | ------: | ---------------------------- | ---------------- |
| 100.0% |  0ms |       1 | `stream(double[], int, int)` | java.util.Arrays |
...
|   1.9% |   0ms |       1 | `exec()` | java.util.concurrent.ForkJoinTask$AdaptedCallable |
...
|  1.3% |   0ms |       1 | `walkFileTree(Path, Set, int, FileVisitor)` (java.nio.file.Files) ← `walkFileTree(Path, FileVisitor)` ← `deleteRecursively(Path, boolean)` (org.renaissance.core.DirUtils) ← `deleteRecursively(Path)` ← `lambda$createScratchDirectory$1(Path)` ← `run()` (org.renaissance.core.DirUtils$$Lambda.0x000000f801003a68) ← `runWith(Object, Runnable)` (java.lang.Thread) ← `run()`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
|  1.2% |   0ms |       1 | `iterator(DirectoryStream)` (sun.nio.fs.UnixDirectoryStream) ← `iterator()` ← `<init>(Path, Object, DirectoryStream)` (java.nio.file.FileTreeWalker$DirectoryNode) ← `visit(Path, boolean, boolean)` (java.nio.file.FileTreeWalker) ← `walk(Path)` ← `walkFileTree(Path, Set, int, FileVisitor)` (java.nio.file.Files) ← `walkFileTree(Path, FileVisitor)` ← `deleteRecursively(Path, boolean)` (org.renaissance.core.DirUtils) ← `deleteRecursively(Path)` ← `lambda$createScratchDirectory$1(Path)` ← `run()` (org.renaissance.core.DirUtils$$Lambda.0x000000f801003a68) ← `runWith(Object, Runnable)` (java.lang.Thread) ← `run()`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|  1.1% |   0ms |       1 | `doubleStream(Spliterator$OfDouble, boolean)` (java.util.stream.StreamSupport) ← `stream(double[], int, int)` (java.util.Arrays) ← `stream(double[])` ← `boxed(double[])` (org.renaissance.jdk.concurrent.JavaKMeans$UpdateTask) ← `computeClusterAverages()` ← `computeDirectly()` ← `computeDirectly()` ← `compute()` (org.renaissance.jdk.concurrent.JavaKMeans$RangedTask) ← `exec()` (java.util.concurrent.RecursiveTask) ← `doExec()` (java.util.concurrent.ForkJoinTask) ← `topLevelExec(ForkJoinTask, ForkJoinPool$WorkQueue)` (java.util.concurrent.ForkJoinPool$WorkQueue) ← `scan(ForkJoinPool$WorkQueue, int, int)` (java.util.concurrent.ForkJoinPool) ← `runWorker(ForkJoinPool$WorkQueue)` ← `run()` (java.util.concurrent.ForkJoinWorkerThread)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
|  1.0% |   0ms |       1 | `loadClass(String, boolean)` (java.lang.ClassLoader) ← `loadClass(String)` ← `boxed(double[])` (org.renaissance.jdk.concurrent.JavaKMeans$UpdateTask) ← `computeClusterAverages()` ← `computeDirectly()` ← `computeDirectly()` ← `compute()` (org.renaissance.jdk.concurrent.JavaKMeans$RangedTask) ← `exec()` (java.util.concurrent.RecursiveTask) ← `doExec()` (java.util.concurrent.ForkJoinTask) ← `topLevelExec(ForkJoinTask, ForkJoinPool$WorkQueue)` (java.util.concurrent.ForkJoinPool$WorkQueue) ← `scan(ForkJoinPool$WorkQueue, int, int)` (java.util.concurrent.ForkJoinPool) ← `runWorker(ForkJoinPool$WorkQueue)` ← `run()` (java.util.concurrent.ForkJoinWorkerThread)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
|  0.2% |   0ms |       1 | `<clinit>()` (java.nio.file.FileTreeWalker$EventType) ← `visit(Path, boolean, boolean)` (java.nio.file.FileTreeWalker) ← `walk(Path)` ← `walkFileTree(Path, Set, int, FileVisitor)` (java.nio.file.Files) ← `walkFileTree(Path, FileVisitor)` ← `deleteRecursively(Path, boolean)` (org.renaissance.core.DirUtils) ← `deleteRecursively(Path)` ← `lambda$createScratchDirectory$1(Path)` ← `run()` (org.renaissance.core.DirUtils$$Lambda.0x000000f801003a68) ← `runWith(Object, Runnable)` (java.lang.Thread) ← `run()`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
