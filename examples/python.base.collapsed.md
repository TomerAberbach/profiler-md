...
|  0.0% |       3 | `fib` (script.py) ← `fib` ← `fib` ← `fib` ← `fib` ← `fib` ← `fib` ← `fib` ← `fib` ← `fib` ← `fib` ← `fib` ← `fib` ← `fib` ← `fib` ← `fib` ← `fib` ← `fib` ← `fib` ← `fib` ← `fib` ← `fib` ← `fib` ← `fib` |
|  0.0% |       2 | `fib` (script.py) ← `fib` ← `fib` ← `fib` ← `fib` ← `fib` ← `fib` ← `fib` ← `fib`                                                                                                                         |
|  0.0% |       1 | `fib` (script.py) ← `fib` ← `fib` ← `fib` ← `fib` ← `fib` ← `fib`                                                                                                                                         |
