...
export const v8HeapProfileToMd = (
  ...
  const rawProfile = parseV8HeapProfile(data)
  const profile = summarizeV8HeapProfile(rawProfile, normalizedOptions)
  return formatV8HeapProfile(profile, normalizedOptions)
}
