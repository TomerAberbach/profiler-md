 ...
 * a given index in {@link AggregatedCallGraph.metrics}. Unlike a sampling
 * profile's measures, there is no sample-count fallback: a call graph has at
 * least one metric.
 */
...
/**
 * The Callers or Callees subsection for one function: its inbound or outgoing
