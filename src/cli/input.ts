...
/** The name reported with a failure the input causes. */
export const inputName = (filePath: string | undefined): string =>
  !filePath || STDIN_PATHS.has(filePath) ? `stdin` : filePath
