...
for role in base current; do
  emit "$FIXTURES/elixir.eflambe.cpu.$role.collapsed" record_eflambe "$role"
done

verify_pair \
  "$FIXTURES/elixir.eflambe.cpu.base.collapsed" \
  "$FIXTURES/elixir.eflambe.cpu.current.collapsed"
