...
| [Rust](docs/languages/rust.md)                                                        | [pprof](docs/formats/pprof.md) ([example 1](examples/rust1.pprof.md), [example 2](examples/rust2.pprof.md)), [Speedscope](docs/formats/speedscope.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
Formats: speedscope, v8-cpu-profile, v8-heap-profile, v8-heap-snapshot, pprof, webkit-timeline-recording
