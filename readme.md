...
| [Java](docs/languages/java.md)⁠/⁠[Kotlin](docs/languages/kotlin.md)                     | [Collapsed stacks](docs/formats/collapsed.md)<br>[pprof](docs/formats/pprof.md)<br>[Speedscope](docs/formats/speedscope.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| [Rust](docs/languages/rust.md)                                                          | [pprof](docs/formats/pprof.md) ([base](examples/rust.base.pprof.md), [diff](examples/rust.diff.pprof.md))<br>[Speedscope](docs/formats/speedscope.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
